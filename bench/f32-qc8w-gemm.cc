  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
...
#if XNN_ARCH_ARM64
  static void f32_qc8w_gemm_minmax_ukernel_1x8__aarch64_neonfma_lane_ld128(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
      xnn_f32_qc8w_gemm_minmax_ukernel_1x8__aarch64_neonfma_lane_ld128,
      xnn_init_f32_minmax_scalar_params,
      /*mr=*/1, /*nr=*/8, /*kr=*/1, /*sr=*/1);
  }
  static void f32_qc8w_gemm_minmax_ukernel_4x8__aarch64_neonfma_lane_ld128(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
      xnn_f32_qc8w_gemm_minmax_ukernel_4x8__aarch64_neonfma_lane_ld128,
      xnn_init_f32_minmax_scalar_params,
      /*mr=*/4, /*nr=*/8, /*kr=*/1, /*sr=*/1);
  }
  static void f32_qc8w_gemm_minmax_ukernel_6x8__aarch64_neonfma_lane_ld128(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
  ...
  BENCHMARK_GEMM(f32_qc8w_gemm_minmax_ukernel_1x8__aarch64_neonfma_lane_ld128)
  BENCHMARK_GEMM(f32_qc8w_gemm_minmax_ukernel_4x8__aarch64_neonfma_lane_ld128)
  BENCHMARK_GEMM(f32_qc8w_gemm_minmax_ukernel_6x8__aarch64_neonfma_lane_ld128)
