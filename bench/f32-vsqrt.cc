...
void f32_vsqrt(benchmark::State& state, xnn_f32_vsqrt_ukernel_fn ukernel,
  ...
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u12,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u16,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u16,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u20,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u20,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u24,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u24,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u28,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u28,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, sse_rsqrt_u32,
                    xnn_f32_vsqrt_ukernel__sse_rsqrt_u32,
                    xnn_init_f32_sqrt_sse_params)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u16,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u24,
                    xnn_f32_vsqrt_ukernel__avx_rsqrt_u24,
                    xnn_init_f32_sqrt_avx_params,
                    benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u32,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u40,
                    xnn_f32_vsqrt_ukernel__avx_rsqrt_u40,
                    xnn_init_f32_sqrt_avx_params,
                    benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u48,
                    xnn_f32_vsqrt_ukernel__avx_rsqrt_u48,
                    xnn_init_f32_sqrt_avx_params,
                    benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u56,
                    xnn_f32_vsqrt_ukernel__avx_rsqrt_u56,
                    xnn_init_f32_sqrt_avx_params,
                    benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx_rsqrt_u64,
                    xnn_f32_vsqrt_ukernel__avx_rsqrt_u64,
                    xnn_init_f32_sqrt_avx_params,
                    benchmark::utils::CheckAVX)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u16,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u24,
                    xnn_f32_vsqrt_ukernel__fma3_rsqrt_u24,
                    xnn_init_f32_sqrt_fma_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u32,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u40,
                    xnn_f32_vsqrt_ukernel__fma3_rsqrt_u40,
                    xnn_init_f32_sqrt_fma_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u48,
                    xnn_f32_vsqrt_ukernel__fma3_rsqrt_u48,
                    xnn_init_f32_sqrt_fma_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u56,
                    xnn_f32_vsqrt_ukernel__fma3_rsqrt_u56,
                    xnn_init_f32_sqrt_fma_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, fma3_rsqrt_u64,
                    xnn_f32_vsqrt_ukernel__fma3_rsqrt_u64,
                    xnn_init_f32_sqrt_fma_params,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  ...
  BENCHMARK_CAPTURE(f32_vsqrt, avx512f_rsqrt_u48,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx512f_rsqrt_u64,
                    xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u64,
                    xnn_init_f32_sqrt_avx512_params,
                    benchmark::utils::CheckAVX512F)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx512f_rsqrt_u80,
                    xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u80,
                    xnn_init_f32_sqrt_avx512_params,
                    benchmark::utils::CheckAVX512F)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx512f_rsqrt_u96,
                    xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u96,
                    xnn_init_f32_sqrt_avx512_params,
                    benchmark::utils::CheckAVX512F)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx512f_rsqrt_u112,
                    xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u112,
                    xnn_init_f32_sqrt_avx512_params,
                    benchmark::utils::CheckAVX512F)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqrt, avx512f_rsqrt_u128,
                    xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u128,
                    xnn_init_f32_sqrt_avx512_params,
                    benchmark::utils::CheckAVX512F)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
