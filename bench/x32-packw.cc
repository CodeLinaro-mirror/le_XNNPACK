  ...
  benchmark::utils::IsaCheckFunction isa_check = nullptr)
{
  ...
  static void x32_packw_x2__neon_vld2_lane(benchmark::State& state, const char* net) {
    x32_packw(state,
      xnn_x32_packw_gemm_goi_ukernel_x2__neon_vld2_lane,
      /*nr=*/2, /*kr=*/1, /*sr=*/1,
      benchmark::utils::CheckNEON);
  }
  static void x32_packw_x8__neon_vld4_lane(benchmark::State& state, const char* net) {
    x32_packw(state,
      xnn_x32_packw_gemm_goi_ukernel_x8__neon_vld4_lane,
      /*nr=*/8, /*kr=*/1, /*sr=*/1,
      benchmark::utils::CheckNEON);
  }
  static void x32_packw_x12__neon_vld4_lane(benchmark::State& state, const char* net) {
    x32_packw(state,
      xnn_x32_packw_gemm_goi_ukernel_x12__neon_vld4_lane,
      /*nr=*/12, /*kr=*/1, /*sr=*/1,
      benchmark::utils::CheckNEON);
  }

  BENCHMARK_BGEMM(x32_packw_x2__neon_vld2_lane)
  BENCHMARK_BGEMM(x32_packw_x8__neon_vld4_lane)
  BENCHMARK_BGEMM(x32_packw_x12__neon_vld4_lane)
