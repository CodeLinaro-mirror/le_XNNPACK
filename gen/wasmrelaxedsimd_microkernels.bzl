...
PROD_WASMRELAXEDSIMD_MICROKERNEL_SRCS = [
    ...
    "src/f32-vcos/gen/f32-vcos-wasmrelaxedsimd-poly-5.c",
    ...
    "src/f32-vsin/gen/f32-vsin-wasmrelaxedsimd-poly-5.c",
...
NON_PROD_WASMRELAXEDSIMD_MICROKERNEL_SRCS = [
...
ALL_WASMRELAXEDSIMD_MICROKERNEL_SRCS = PROD_WASMRELAXEDSIMD_MICROKERNEL_SRCS + NON_PROD_WASMRELAXEDSIMD_MICROKERNEL_SRCS
