...
tools/xngen src/f32-vbinary/vop-hvx.c.in -D OP=DIV         -D BATCH_TILE=32  -D -o src/f32-vbinary/gen/f32-vdiv-hvx-u32.c &
tools/xngen src/f32-vbinary/vop-hvx.c.in -D OP=DIV         -D BATCH_TILE=64  -D -o src/f32-vbinary/gen/f32-vdiv-hvx-u64.c &
tools/xngen src/f32-vbinary/vop-hvx.c.in -D OP=DIV         -D BATCH_TILE=128 -D -o src/f32-vbinary/gen/f32-vdiv-hvx-u128.c &
...
tools/xngen src/f32-vbinary/vopc-hvx.c.in -D OP=DIV        -D BATCH_TILE=32  -D -o src/f32-vbinary/gen/f32-vdivc-hvx-u32.c &
tools/xngen src/f32-vbinary/vopc-hvx.c.in -D OP=DIV        -D BATCH_TILE=64  -D -o src/f32-vbinary/gen/f32-vdivc-hvx-u64.c &
tools/xngen src/f32-vbinary/vopc-hvx.c.in -D OP=DIV        -D BATCH_TILE=128 -D -o src/f32-vbinary/gen/f32-vdivc-hvx-u128.c &
...
tools/xngen src/f32-vbinary/vopc-hvx.c.in -D OP=RDIV       -D BATCH_TILE=32  -D -o src/f32-vbinary/gen/f32-vrdivc-hvx-u32.c &
tools/xngen src/f32-vbinary/vopc-hvx.c.in -D OP=RDIV       -D BATCH_TILE=64  -D -o src/f32-vbinary/gen/f32-vrdivc-hvx-u64.c &
tools/xngen src/f32-vbinary/vopc-hvx.c.in -D OP=RDIV       -D BATCH_TILE=128 -D -o src/f32-vbinary/gen/f32-vrdivc-hvx-u128.c &
