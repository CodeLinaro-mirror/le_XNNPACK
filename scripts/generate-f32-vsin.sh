...
################################# Polynomial ###################################
tools/xngen src/f32-vsin/poly-5.c.in -D FUN=SIN -D ARCH=scalar          -D BATCH_TILES=1,2,4,8      -o src/f32-vsin/gen/f32-vsin-scalar-poly-5.c &
tools/xngen src/f32-vsin/poly-5.c.in -D FUN=SIN -D ARCH=wasmrelaxedsimd -D BATCH_TILES=4,8,16        -o src/f32-vsin/gen/f32-vsin-wasmrelaxedsimd-poly-5.c &
tools/xngen src/f32-vsin/poly-5.c.in -D FUN=SIN -D ARCH=neon            -D BATCH_TILES=4,8,16        -o src/f32-vsin/gen/f32-vsin-neon-poly-5.c &
tools/xngen src/f32-vsin/poly-5.c.in -D FUN=SIN -D ARCH=fma3            -D BATCH_TILES=8,16,24,32   -o src/f32-vsin/gen/f32-vsin-fma3-poly-5.c &
tools/xngen src/f32-vsin/poly-5.c.in -D FUN=SIN -D ARCH=avx512f         -D BATCH_TILES=16,32,48,64  -o src/f32-vsin/gen/f32-vsin-avx512f-poly-5.c &
tools/xngen src/f32-vsin/rvv-poly-5.c.in -D FUN=SIN -D LMUL=1 -o src/f32-vsin/gen/f32-vsin-rvv-poly-5-u1v.c &
tools/xngen src/f32-vsin/rvv-poly-5.c.in -D FUN=SIN -D LMUL=2 -o src/f32-vsin/gen/f32-vsin-rvv-poly-5-u2v.c &
tools/xngen src/f32-vsin/rvv-poly-5.c.in -D FUN=SIN -D LMUL=4 -o src/f32-vsin/gen/f32-vsin-rvv-poly-5-u4v.c &
tools/xngen src/f32-vsin/rvv-poly-5.c.in -D FUN=SIN -D LMUL=8 -o src/f32-vsin/gen/f32-vsin-rvv-poly-5-u8v.c &
