...
void xnn_qd8_f16_qc8w_gemm_minmax_ukernel_1x16c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
...
void xnn_qd8_f16_qc8w_gemm_minmax_ukernel_1x8c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
    const int8_t* restrict a,
...
void xnn_qd8_f16_qc8w_gemm_minmax_ukernel_4x8c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
    const int8_t* restrict a,
...
void xnn_qd8_f16_qc8w_igemm_minmax_ukernel_1x8c4__neondotfp16arith(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
