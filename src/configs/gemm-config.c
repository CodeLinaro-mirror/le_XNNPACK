...
static void init_qd8_f32_qc8w_gemm_config(void) {
    ...
    if (!XNN_PLATFORM_MOBILE && hardware_config->use_x86_avx512amx) {
      ...
      qd8_f32_qc8w_gemm_config.minmax.dqgemm[XNN_MR_TO_INDEX(16)] = xnn_init_hmp_dqgemm_ukernel((xnn_dqgemm_ukernel_fn) xnn_qd8_f32_qc8w_gemm_minmax_ukernel_16x16c4__avx512amx);
      ...
      qd8_f32_qc8w_gemm_config.minmax.dqigemm[XNN_MR_TO_INDEX(16)] = xnn_init_hmp_dqigemm_ukernel((xnn_dqigemm_ukernel_fn) xnn_qd8_f32_qc8w_igemm_minmax_ukernel_16x16c4__avx512vnni_prfm);
