    ...
    const union xnn_f16_f32acc_scale_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; channels >= 64; channels -= 64) {
    ...
    float16x4_t vo0 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo1 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo2 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo3 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo4 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo5 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo6 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo7 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo8 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo9 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo10 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo11 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo12 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo13 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo14 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
    float16x4_t vo15 = vreinterpret_u16_f16(vld1_u16(o)); o += 4;
