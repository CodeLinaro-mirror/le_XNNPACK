...
void xnn_f16_vcos_ukernel__scalar_rational_3_2_div_u1(
    size_t batch,
...
void xnn_f16_vcos_ukernel__scalar_rational_3_2_div_u2(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vcos_ukernel__scalar_rational_3_2_div_u4(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 4 * sizeof(xnn_float16); batch -= 4 * sizeof(xnn_float16)) {
    ...
    vx_3 = xnn_sub_f16(vpi_half, vx_3);
    vx_0 = xnn_min_f16(vx_0, xnn_sub_f16(vpi, vx_0));
    vx_1 = xnn_min_f16(vx_1, xnn_sub_f16(vpi, vx_1));
...
void xnn_f16_vcos_ukernel__scalar_rational_3_2_div_u8(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
{
  ...
  for (; batch >= 8 * sizeof(xnn_float16); batch -= 8 * sizeof(xnn_float16)) {
    ...
    vx_2 = xnn_sub_f16(vpi_half, vx_2);
    vx_3 = xnn_sub_f16(vpi_half, vx_3);
    vx_4 = xnn_sub_f16(vpi_half, vx_4);
    vx_5 = xnn_sub_f16(vpi_half, vx_5);
    vx_6 = xnn_sub_f16(vpi_half, vx_6);
    vx_7 = xnn_sub_f16(vpi_half, vx_7);
    vx_0 = xnn_min_f16(vx_0, xnn_sub_f16(vpi, vx_0));
    vx_1 = xnn_min_f16(vx_1, xnn_sub_f16(vpi, vx_1));
    vx_2 = xnn_min_f16(vx_2, xnn_sub_f16(vpi, vx_2));
    vx_3 = xnn_min_f16(vx_3, xnn_sub_f16(vpi, vx_3));
