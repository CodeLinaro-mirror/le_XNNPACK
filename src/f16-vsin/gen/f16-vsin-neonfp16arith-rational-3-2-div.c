...
void xnn_f16_vsin_ukernel__neonfp16arith_rational_3_2_div_u8(
    size_t batch,
...
void xnn_f16_vsin_ukernel__neonfp16arith_rational_3_2_div_u16(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
...
void xnn_f16_vsin_ukernel__neonfp16arith_rational_3_2_div_u32(
    size_t batch,
    const xnn_float16* input,
    xnn_float16* output,
    const struct xnn_f16_default_params* unused_params)
