...
void xnn_f16_vsin_ukernel__rvvfp16arith_poly_3_u1v(
    size_t batch,
    ...
    const struct xnn_f16_default_params* unused_params)
{
  ...
  do {
    ...
    vfloat16m1_t vy = __riscv_vfmul(vx, vone_over_pi, vl);
    ...
    vuint16m1_t vu_k = __riscv_vreinterpret_u16m1(vk);
    vuint16m1_t vsign_flip = __riscv_vsll(vu_k, 15, vl);
