...
void xnn_f16_vsin_ukernel__rvvfp16arith_poly_3_u2v(
    size_t batch,
    ...
    const struct xnn_f16_default_params* unused_params)
{
  ...
  do {
    ...
    vfloat16m2_t vy = __riscv_vfmul(vx, vone_over_pi, vl);
    ...
    vuint16m2_t vu_k = __riscv_vreinterpret_u16m2(vk);
    vuint16m2_t vsign_flip = __riscv_vsll(vu_k, 15, vl);
    ...
    vfloat16m2_t vp = __riscv_vfadd(__riscv_vfmul(vx2, vc3, vl), vc2, vl);
