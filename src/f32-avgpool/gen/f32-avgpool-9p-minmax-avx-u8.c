...
void xnn_f32_avgpool_minmax_ukernel_9p__avx_u8(
    ...
    const struct xnn_f32_scaleminmax_params* restrict params)
{
  ...
  do {
    ...
    for (; k > 9; k -= 9) {
      ...
      size_t c = channels;
      for (; c >= 8; c -= 8) {
        const xnn_simd_f32_t vi0 = xnn_loadu_f32(i0); i0 += 8;
        const xnn_simd_f32_t vi1 = xnn_loadu_f32(i1); i1 += 8;
        const xnn_simd_f32_t vi2 = xnn_loadu_f32(i2); i2 += 8;
        const xnn_simd_f32_t vi3 = xnn_loadu_f32(i3); i3 += 8;
        const xnn_simd_f32_t vi4 = xnn_loadu_f32(i4); i4 += 8;
        const xnn_simd_f32_t vi5 = xnn_loadu_f32(i5); i5 += 8;
        const xnn_simd_f32_t vi6 = xnn_loadu_f32(i6); i6 += 8;
        const xnn_simd_f32_t vi7 = xnn_loadu_f32(i7); i7 += 8;
        const xnn_simd_f32_t vi8 = xnn_loadu_f32(i8); i8 += 8;
        const xnn_simd_f32_t vprev = xnn_loadu_f32(prev_output); prev_output += 8;
