...
void xnn_f32_dwconv_minmax_ukernel_25p64c__hvx(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
    ...
    const struct xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; c >= 64; c -= 64) {
      ...
      vacc32p0 = xnn_fmadd_f32(vi9x32, vk9x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi11x32, vk11x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi13x32, vk13x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi15x32, vk15x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi17x32, vk17x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi19x32, vk19x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi21x32, vk21x32, vacc32p0);
      ...
      vacc32p0 = xnn_fmadd_f32(vi23x32, vk23x32, vacc32p0);
    ...
    if XNN_UNLIKELY(c != 0) {
      ...
      xnn_simd_f32_t vacc0p0 = xnn_load_tail_f32(w, c >> XNN_LOG2_SIZEOF_FLOAT));

      const xnn_simd_f32_t vi0x0 = xnn_load_tail_f32(i0, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk0x0 = xnn_load_tail_f32(w + 64, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi0x0, vk0x0, vacc0p0);

      const xnn_simd_f32_t vi1x0 = xnn_load_tail_f32(i1, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk1x0 = xnn_load_tail_f32(w + 128, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi1x0, vk1x0, vacc0p0);

      const xnn_simd_f32_t vi2x0 = xnn_load_tail_f32(i2, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk2x0 = xnn_load_tail_f32(w + 192, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi2x0, vk2x0, vacc0p0);

      const xnn_simd_f32_t vi3x0 = xnn_load_tail_f32(i3, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk3x0 = xnn_load_tail_f32(w + 256, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi3x0, vk3x0, vacc0p0);

      const xnn_simd_f32_t vi4x0 = xnn_load_tail_f32(i4, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk4x0 = xnn_load_tail_f32(w + 320, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi4x0, vk4x0, vacc0p0);

      const xnn_simd_f32_t vi5x0 = xnn_load_tail_f32(i5, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk5x0 = xnn_load_tail_f32(w + 384, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi5x0, vk5x0, vacc0p0);

      const xnn_simd_f32_t vi6x0 = xnn_load_tail_f32(i6, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk6x0 = xnn_load_tail_f32(w + 448, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi6x0, vk6x0, vacc0p0);

      const xnn_simd_f32_t vi7x0 = xnn_load_tail_f32(i7, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk7x0 = xnn_load_tail_f32(w + 512, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi7x0, vk7x0, vacc0p0);

      const xnn_simd_f32_t vi8x0 = xnn_load_tail_f32(i8, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk8x0 = xnn_load_tail_f32(w + 576, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi8x0, vk8x0, vacc0p0);

      const xnn_simd_f32_t vi9x0 = xnn_load_tail_f32(i9, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk9x0 = xnn_load_tail_f32(w + 640, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi9x0, vk9x0, vacc0p0);

      const xnn_simd_f32_t vi10x0 = xnn_load_tail_f32(i10, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk10x0 = xnn_load_tail_f32(w + 704, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi10x0, vk10x0, vacc0p0);

      const xnn_simd_f32_t vi11x0 = xnn_load_tail_f32(i11, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk11x0 = xnn_load_tail_f32(w + 768, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi11x0, vk11x0, vacc0p0);

      const xnn_simd_f32_t vi12x0 = xnn_load_tail_f32(i12, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk12x0 = xnn_load_tail_f32(w + 832, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi12x0, vk12x0, vacc0p0);

      const xnn_simd_f32_t vi13x0 = xnn_load_tail_f32(i13, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk13x0 = xnn_load_tail_f32(w + 896, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi13x0, vk13x0, vacc0p0);

      const xnn_simd_f32_t vi14x0 = xnn_load_tail_f32(i14, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk14x0 = xnn_load_tail_f32(w + 960, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi14x0, vk14x0, vacc0p0);

      const xnn_simd_f32_t vi15x0 = xnn_load_tail_f32(i15, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk15x0 = xnn_load_tail_f32(w + 1024, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi15x0, vk15x0, vacc0p0);

      const xnn_simd_f32_t vi16x0 = xnn_load_tail_f32(i16, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk16x0 = xnn_load_tail_f32(w + 1088, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi16x0, vk16x0, vacc0p0);

      const xnn_simd_f32_t vi17x0 = xnn_load_tail_f32(i17, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk17x0 = xnn_load_tail_f32(w + 1152, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi17x0, vk17x0, vacc0p0);

      const xnn_simd_f32_t vi18x0 = xnn_load_tail_f32(i18, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk18x0 = xnn_load_tail_f32(w + 1216, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi18x0, vk18x0, vacc0p0);

      const xnn_simd_f32_t vi19x0 = xnn_load_tail_f32(i19, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk19x0 = xnn_load_tail_f32(w + 1280, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi19x0, vk19x0, vacc0p0);

      const xnn_simd_f32_t vi20x0 = xnn_load_tail_f32(i20, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk20x0 = xnn_load_tail_f32(w + 1344, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi20x0, vk20x0, vacc0p0);

      const xnn_simd_f32_t vi21x0 = xnn_load_tail_f32(i21, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk21x0 = xnn_load_tail_f32(w + 1408, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi21x0, vk21x0, vacc0p0);

      const xnn_simd_f32_t vi22x0 = xnn_load_tail_f32(i22, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk22x0 = xnn_load_tail_f32(w + 1472, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi22x0, vk22x0, vacc0p0);

      const xnn_simd_f32_t vi23x0 = xnn_load_tail_f32(i23, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk23x0 = xnn_load_tail_f32(w + 1536, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi23x0, vk23x0, vacc0p0);

      const xnn_simd_f32_t vi24x0 = xnn_load_tail_f32(i24, c >> XNN_LOG2_SIZEOF_FLOAT));
      const xnn_simd_f32_t vk24x0 = xnn_load_tail_f32(w + 1600, c >> XNN_LOG2_SIZEOF_FLOAT));
      vacc0p0 = xnn_fmadd_f32(vi24x0, vk24x0, vacc0p0);
      ...
      xnn_store_tail_f32(output, vacc0, c >> XNN_LOG2_SIZEOF_FLOAT));
      output += c;
    }
