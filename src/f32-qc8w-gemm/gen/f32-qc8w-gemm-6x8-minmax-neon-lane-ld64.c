    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    float32x4_t vacc0x0123 = vld1q_f32(w); w = (const void*) ((const float*) w + 4);
    float32x4_t vacc0x4567 = vld1q_f32(w); w = (const void*) ((const float*) w + 4);
    ...
    if XNN_UNLIKELY(k != 0) {
      ...
      const int8x8_t vw0123 = vreinterpret_s8_u32(vld1_dup_u32(w)); w = (const int8_t*) w + 4;
      const int8x8_t vw4567 = vreinterpret_s8_u32(vld1_dup_u32(w)); w = (const int8_t*) w + 4;
      const int16x8_t vxw0123 = vmovl_s8(vw0123);
      const int16x8_t vxw4567 = vmovl_s8(vw4567);
      const int32x4_t vxxw0123 = vmovl_s16(vget_low_s16(vxw0123));
      const int32x4_t vxxw4567 = vmovl_s16(vget_low_s16(vxw4567));
      const float32x4_t vb0123 = vcvtq_f32_s32(vxxw0123);
      const float32x4_t vb4567 = vcvtq_f32_s32(vxxw4567);
    ...
    const float32x4_t vscale0123 = vld1q_f32(w); w = (const void*) ((const float*) w + 4);
    ...
    const float32x4_t vscale4567 = vld1q_f32(w); w = (const void*) ((const float*) w + 4);
