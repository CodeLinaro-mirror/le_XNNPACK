    ...
    const union xnn_f32_scale_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; channels >= 128; channels -= 128) {
    ...
    __m512 vo0 = _mm512_loadu_ps(o); o += 16;
    __m512 vo1 = _mm512_loadu_ps(o); o += 16;
    __m512 vo2 = _mm512_loadu_ps(o); o += 16;
    __m512 vo3 = _mm512_loadu_ps(o); o += 16;
    __m512 vo4 = _mm512_loadu_ps(o); o += 16;
    __m512 vo5 = _mm512_loadu_ps(o); o += 16;
    __m512 vo6 = _mm512_loadu_ps(o); o += 16;
    __m512 vo7 = _mm512_loadu_ps(o); o += 16;
