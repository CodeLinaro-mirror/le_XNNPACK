...
void xnn_f32_vapproxgelu_ukernel__wasmsimd_rational_12_10_div_u8(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vapproxgelu_ukernel__wasmsimd_rational_12_10_div_u12(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vapproxgelu_ukernel__wasmsimd_rational_12_10_div_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
