...
void xnn_f32_vcopysign_ukernel__hvx_u32(
    size_t batch,
    const float* mag,
    const float* sign,
    float* output,
...
void xnn_f32_vcopysign_ukernel__hvx_u64(
    size_t batch,
    const float* mag,
    const float* sign,
    float* output,
...
void xnn_f32_vcopysign_ukernel__hvx_u96(
    size_t batch,
    const float* mag,
    const float* sign,
    float* output,
...
void xnn_f32_vcopysign_ukernel__hvx_u128(
    size_t batch,
    const float* mag,
    const float* sign,
    float* output,
