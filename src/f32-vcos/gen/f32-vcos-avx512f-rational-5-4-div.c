...
void xnn_f32_vcos_ukernel__avx512f_rational_5_4_div_u16(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vcos_ukernel__avx512f_rational_5_4_div_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vcos_ukernel__avx512f_rational_5_4_div_u48(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vcos_ukernel__avx512f_rational_5_4_div_u64(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
