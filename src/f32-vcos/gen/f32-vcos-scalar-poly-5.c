...
//   Template: src/f32-vsin/poly-5.c.in
...
void xnn_f32_vcos_ukernel__scalar_poly_5_u1(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  XNN_SIMD_CONST_F32(vc5, -6.2255153921e-08f);
  XNN_SIMD_CONST_F32(vc4, 2.9789207474e-06f);
  ...
  for (; batch >= xnn_simd_bytes_f32; batch -= xnn_simd_bytes_f32) {
    ...
    xnn_simd_f32_t vp = xnn_fmadd_f32(vx2, vc5, vc4);
    vp = xnn_fmadd_f32(vx2, vp, vc3);
...
void xnn_f32_vcos_ukernel__scalar_poly_5_u2(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 2 * sizeof(float); batch -= 2 * sizeof(float)) {
    ...
    xnn_simd_f32_t vp_0 = xnn_fmadd_f32(vx2_0, vc5, vc4);
    xnn_simd_f32_t vp_1 = xnn_fmadd_f32(vx2_1, vc5, vc4);
    vp_0 = xnn_fmadd_f32(vx2_0, vp_0, vc3);
    vp_1 = xnn_fmadd_f32(vx2_1, vp_1, vc3);
...
void xnn_f32_vcos_ukernel__scalar_poly_5_u4(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 4 * sizeof(float); batch -= 4 * sizeof(float)) {
    ...
    xnn_simd_f32_t vp_0 = xnn_fmadd_f32(vx2_0, vc5, vc4);
    xnn_simd_f32_t vp_1 = xnn_fmadd_f32(vx2_1, vc5, vc4);
    xnn_simd_f32_t vp_2 = xnn_fmadd_f32(vx2_2, vc5, vc4);
    xnn_simd_f32_t vp_3 = xnn_fmadd_f32(vx2_3, vc5, vc4);
    vp_0 = xnn_fmadd_f32(vx2_0, vp_0, vc3);
    vp_1 = xnn_fmadd_f32(vx2_1, vp_1, vc3);
    vp_2 = xnn_fmadd_f32(vx2_2, vp_2, vc3);
    vp_3 = xnn_fmadd_f32(vx2_3, vp_3, vc3);
    vp_0 = xnn_fmadd_f32(vx2_0, vp_0, vc2);
    vp_1 = xnn_fmadd_f32(vx2_1, vp_1, vc2);
...
void xnn_f32_vcos_ukernel__scalar_poly_5_u8(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
{
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    xnn_simd_f32_t vp_2 = xnn_fmadd_f32(vx2_2, vc5, vc4);
    xnn_simd_f32_t vp_3 = xnn_fmadd_f32(vx2_3, vc5, vc4);
    xnn_simd_f32_t vp_4 = xnn_fmadd_f32(vx2_4, vc5, vc4);
    xnn_simd_f32_t vp_5 = xnn_fmadd_f32(vx2_5, vc5, vc4);
    xnn_simd_f32_t vp_6 = xnn_fmadd_f32(vx2_6, vc5, vc4);
    xnn_simd_f32_t vp_7 = xnn_fmadd_f32(vx2_7, vc5, vc4);
    vp_0 = xnn_fmadd_f32(vx2_0, vp_0, vc3);
    vp_1 = xnn_fmadd_f32(vx2_1, vp_1, vc3);
    vp_2 = xnn_fmadd_f32(vx2_2, vp_2, vc3);
    vp_3 = xnn_fmadd_f32(vx2_3, vp_3, vc3);
    vp_4 = xnn_fmadd_f32(vx2_4, vp_4, vc3);
    vp_5 = xnn_fmadd_f32(vx2_5, vp_5, vc3);
    vp_6 = xnn_fmadd_f32(vx2_6, vp_6, vc3);
    vp_7 = xnn_fmadd_f32(vx2_7, vp_7, vc3);
    vp_0 = xnn_fmadd_f32(vx2_0, vp_0, vc2);
    vp_1 = xnn_fmadd_f32(vx2_1, vp_1, vc2);
    vp_2 = xnn_fmadd_f32(vx2_2, vp_2, vc2);
    vp_3 = xnn_fmadd_f32(vx2_3, vp_3, vc2);
