...
void xnn_f32_vexp_ukernel__avx_rational_3_2_div_u8(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vexp_ukernel__avx_rational_3_2_div_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vexp_ukernel__avx_rational_3_2_div_u24(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vexp_ukernel__avx_rational_3_2_div_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
