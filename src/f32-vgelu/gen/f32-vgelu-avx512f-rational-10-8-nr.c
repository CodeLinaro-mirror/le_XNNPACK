    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= xnn_simd_bytes_f32; batch -= xnn_simd_bytes_f32) {
    ...
    const xnn_simd_f32_t verf_plus_one = xnn_fmadd_f32(vp, vrq, vone);
    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const xnn_simd_f32_t verf_plus_one_0 = xnn_fmadd_f32(vp_0, vrq_0, vone);
    const xnn_simd_f32_t verf_plus_one_1 = xnn_fmadd_f32(vp_1, vrq_1, vone);
    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 48 * sizeof(float); batch -= 48 * sizeof(float)) {
    ...
    const xnn_simd_f32_t verf_plus_one_0 = xnn_fmadd_f32(vp_0, vrq_0, vone);
    const xnn_simd_f32_t verf_plus_one_1 = xnn_fmadd_f32(vp_1, vrq_1, vone);
    const xnn_simd_f32_t verf_plus_one_2 = xnn_fmadd_f32(vp_2, vrq_2, vone);
    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const xnn_simd_f32_t verf_plus_one_1 = xnn_fmadd_f32(vp_1, vrq_1, vone);
    const xnn_simd_f32_t verf_plus_one_2 = xnn_fmadd_f32(vp_2, vrq_2, vone);
    const xnn_simd_f32_t verf_plus_one_3 = xnn_fmadd_f32(vp_3, vrq_3, vone);
