...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_nr_u8(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_nr_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_nr_u24(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vlog_ukernel__fma3_rational_3_3_nr_u32(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
