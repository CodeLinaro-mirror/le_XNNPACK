    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  XNN_SIMD_CONST_F32(vsqrt2, M_SQRT2);
  XNN_SIMD_CONST_F32(vsqrt1_2, M_SQRT1_2);
  ...
  for (; batch >= xnn_simd_bytes_f32; batch -= xnn_simd_bytes_f32) {
    ...
    vx = xnn_fmsub_f32(vx, vsqrt1_2, vone);
    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(float); batch -= 2 * sizeof(float)) {
    ...
    // `[sqrt(1/2), sqrt(2))`, and further subtract `1.0` so that it is around
    // zero, i.e. `[sqrt(1/2) - 1, sqrt(2) - 1)`, or `[−0.29289, 0.4142136)`.
    vx_0 = xnn_fmsub_f32(vx_0, vsqrt1_2, vone);
    vx_1 = xnn_fmsub_f32(vx_1, vsqrt1_2, vone);
    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(float); batch -= 4 * sizeof(float)) {
    ...
    vx_0 = xnn_fmsub_f32(vx_0, vsqrt1_2, vone);
    vx_1 = xnn_fmsub_f32(vx_1, vsqrt1_2, vone);
    vx_2 = xnn_fmsub_f32(vx_2, vsqrt1_2, vone);
    vx_3 = xnn_fmsub_f32(vx_3, vsqrt1_2, vone);
    ...
    const union xnn_f32_default_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    vx_2 = xnn_fmsub_f32(vx_2, vsqrt1_2, vone);
    vx_3 = xnn_fmsub_f32(vx_3, vsqrt1_2, vone);
    vx_4 = xnn_fmsub_f32(vx_4, vsqrt1_2, vone);
    vx_5 = xnn_fmsub_f32(vx_5, vsqrt1_2, vone);
    vx_6 = xnn_fmsub_f32(vx_6, vsqrt1_2, vone);
    vx_7 = xnn_fmsub_f32(vx_7, vsqrt1_2, vone);
