...
void xnn_f32_vsin_ukernel__wasmrelaxedsimd_poly_5_u4(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vsin_ukernel__wasmrelaxedsimd_poly_5_u8(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
...
void xnn_f32_vsin_ukernel__wasmrelaxedsimd_poly_5_u16(
    size_t batch,
    const float* input,
    float* output,
    const struct xnn_f32_default_params* unused_params)
