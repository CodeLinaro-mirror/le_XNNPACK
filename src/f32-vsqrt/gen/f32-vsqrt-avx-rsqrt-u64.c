...
void xnn_f32_vsqrt_ukernel__avx_rsqrt_u64(
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const __m256 vt2_5 = _mm256_mul_ps(va5, vt1_5);
    const __m256 vt2_6 = _mm256_mul_ps(va6, vt1_6);
    const __m256 vt2_7 = _mm256_mul_ps(va7, vt1_7);
    ...
    const __m256 vt3_5 = _mm256_sub_ps(kThree, vt2_5);
    const __m256 vt3_6 = _mm256_sub_ps(kThree, vt2_6);
    const __m256 vt3_7 = _mm256_sub_ps(kThree, vt2_7);
    ...
    const __m256 vt4_5 = _mm256_mul_ps(kHalf, vt0_5);
    const __m256 vt4_6 = _mm256_mul_ps(kHalf, vt0_6);
    const __m256 vt4_7 = _mm256_mul_ps(kHalf, vt0_7);
    ...
    const __m256 vy5 = _mm256_mul_ps(va5, vt7_5);
    const __m256 vy6 = _mm256_mul_ps(va6, vt7_6);
    const __m256 vy7 = _mm256_mul_ps(va7, vt7_7);
