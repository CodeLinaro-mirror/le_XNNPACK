    ...
    const union xnn_f32_sqrt_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const __m128 vt3_4 = _mm_sub_ps(vthree, vt2_4);
    const __m128 vt3_5 = _mm_sub_ps(vthree, vt2_5);
    const __m128 vt3_6 = _mm_sub_ps(vthree, vt2_6);
    const __m128 vt3_7 = _mm_sub_ps(vthree, vt2_7);
    ...
    const __m128 vt4_4 = _mm_mul_ps(vhalf, vt0_4);
    const __m128 vt4_5 = _mm_mul_ps(vhalf, vt0_5);
    const __m128 vt4_6 = _mm_mul_ps(vhalf, vt0_6);
    const __m128 vt4_7 = _mm_mul_ps(vhalf, vt0_7);
