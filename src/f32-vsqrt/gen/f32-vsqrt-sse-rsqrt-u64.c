    ...
    const union xnn_f32_sqrt_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  for (; batch >= 64 * sizeof(float); batch -= 64 * sizeof(float)) {
    ...
    const __m128 vx8 = _mm_loadu_ps(input + 32);
    const __m128 vx9 = _mm_loadu_ps(input + 36);
    const __m128 vxA = _mm_loadu_ps(input + 40);
    const __m128 vxB = _mm_loadu_ps(input + 44);
    const __m128 vxC = _mm_loadu_ps(input + 48);
    const __m128 vxD = _mm_loadu_ps(input + 52);
    const __m128 vxE = _mm_loadu_ps(input + 56);
    const __m128 vxF = _mm_loadu_ps(input + 60);
    input += 64;
    ...
    const __m128 vt0_4 = _mm_rsqrt_ps(vx4);
    const __m128 vt0_5 = _mm_rsqrt_ps(vx5);
    const __m128 vt0_6 = _mm_rsqrt_ps(vx6);
    const __m128 vt0_7 = _mm_rsqrt_ps(vx7);
    const __m128 vt0_8 = _mm_rsqrt_ps(vx8);
    const __m128 vt0_9 = _mm_rsqrt_ps(vx9);
    const __m128 vt0_A = _mm_rsqrt_ps(vxA);
    const __m128 vt0_B = _mm_rsqrt_ps(vxB);
    const __m128 vt0_C = _mm_rsqrt_ps(vxC);
    const __m128 vt0_D = _mm_rsqrt_ps(vxD);
    const __m128 vt0_E = _mm_rsqrt_ps(vxE);
    const __m128 vt0_F = _mm_rsqrt_ps(vxF);
    ...
    const __m128 vt2_4 = _mm_mul_ps(vx4, vt1_4);
    const __m128 vt2_5 = _mm_mul_ps(vx5, vt1_5);
    const __m128 vt2_6 = _mm_mul_ps(vx6, vt1_6);
    const __m128 vt2_7 = _mm_mul_ps(vx7, vt1_7);
    const __m128 vt2_8 = _mm_mul_ps(vx8, vt1_8);
    const __m128 vt2_9 = _mm_mul_ps(vx9, vt1_9);
    const __m128 vt2_A = _mm_mul_ps(vxA, vt1_A);
    const __m128 vt2_B = _mm_mul_ps(vxB, vt1_B);
    const __m128 vt2_C = _mm_mul_ps(vxC, vt1_C);
    const __m128 vt2_D = _mm_mul_ps(vxD, vt1_D);
    const __m128 vt2_E = _mm_mul_ps(vxE, vt1_E);
    const __m128 vt2_F = _mm_mul_ps(vxF, vt1_F);
    ...
    const __m128 vy3 = _mm_mul_ps(vx3, vt7_3);
    const __m128 vy4 = _mm_mul_ps(vx4, vt7_4);
    const __m128 vy5 = _mm_mul_ps(vx5, vt7_5);
    const __m128 vy6 = _mm_mul_ps(vx6, vt7_6);
    const __m128 vy7 = _mm_mul_ps(vx7, vt7_7);
    const __m128 vy8 = _mm_mul_ps(vx8, vt7_8);
    const __m128 vy9 = _mm_mul_ps(vx9, vt7_9);
    const __m128 vyA = _mm_mul_ps(vxA, vt7_A);
    const __m128 vyB = _mm_mul_ps(vxB, vt7_B);
    const __m128 vyC = _mm_mul_ps(vxC, vt7_C);
    const __m128 vyD = _mm_mul_ps(vxD, vt7_D);
    const __m128 vyE = _mm_mul_ps(vxE, vt7_E);
    const __m128 vyF = _mm_mul_ps(vxF, vt7_F);
