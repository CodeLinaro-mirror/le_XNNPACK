...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_div_u8(
    size_t batch,
    const float* input,
    float* output,
...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_div_u24(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_div_u32(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
