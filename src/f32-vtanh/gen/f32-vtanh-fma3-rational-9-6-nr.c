...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_nr_u8(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  // which the interpolation returns 1.0f.
    ...
    XNN_SIMD_STATIC_INIT_F32(vmax_x, 7.646893501282f);
    XNN_SIMD_STATIC_INIT_F32(vmin_x, -7.646893501282f);
  #else
    XNN_SIMD_STATIC_INIT_F32(vmax_x, 7.623543739319f);
    XNN_SIMD_STATIC_INIT_F32(vmin_x, -7.623543739319f);
  #endif  // XNN_SIMD_HAS_NATIVE_FMA
  
  // The monomial coefficients of the numerator polynomial (odd).
  XNN_SIMD_STATIC_INIT_F32(valpha_1, -9.022999554873e-03f);
  XNN_SIMD_STATIC_INIT_F32(valpha_3, -1.146968104877e-03f);
  XNN_SIMD_STATIC_INIT_F32(valpha_5, -2.432360815874e-05f);
  XNN_SIMD_STATIC_INIT_F32(valpha_7, -6.458659385089e-08f);
  XNN_SIMD_STATIC_INIT_F32(valpha_9, 5.535878699892e-11f);

  // The monomial coefficients of the denominator polynomial (even).
  XNN_SIMD_STATIC_INIT_F32(vbeta_0, -9.023001417518e-03f);
  XNN_SIMD_STATIC_INIT_F32(vbeta_2, -4.154618829489e-03f);
  XNN_SIMD_STATIC_INIT_F32(vbeta_4, -2.061512641376e-04f);
  XNN_SIMD_STATIC_INIT_F32(vbeta_6, -1.774490101525e-06f);
  
  // Constant needed for the Newton-Raphson iteration of the reciprocal.
  XNN_SIMD_STATIC_INIT_F32(vtwo, 2.0f);
...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_nr_u16(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_nr_u24(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_f32_vtanh_ukernel__fma3_rational_9_6_nr_u32(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_tanh_params unused_params[restrict XNN_MIN_ELEMENTS(1)])
