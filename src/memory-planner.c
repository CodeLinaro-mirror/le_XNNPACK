...
static void populate_value_lifecycle(const xnn_runtime_t runtime, struct xnn_value_usage* usage) {
  assert(runtime != NULL);
...
void xnn_init_value_allocation_tracker(struct xnn_value_allocation_tracker* tracker, const xnn_runtime_t runtime) {
