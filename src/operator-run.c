    ...
    size_t nr_block_size)
{
  ...
  context->qd_ukernel.function[XNN_UARCH_DEFAULT](
      mr_block_size,
      nr_block_size,
      context->k_scaled,
      (const void*) ((uintptr_t) context->a + mr_block_start * a_stride),
      ...
      context->cn_stride,
      context->fused_params,
      (const void*) ((uintptr_t) context->quantization_params + mr_block_start * sizeof(struct xnn_qd8_quantization_params)));
}
