...
void xnn_qd8_f32_qc4w_gemm_minmax_ukernel_8x16c4__avx512vnni_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    while (k >= 8 * sizeof(int8_t)) {
       ...
       a5 += 4;
       __m512i va6x0123c0 = _mm512_set1_epi32((int) unaligned_load_u32(a6));
       a6 += 4;
       __m512i va7x0123c0 = _mm512_set1_epi32((int) unaligned_load_u32(a7));
       a7 += 4;
       ...
       va6x0123c0 = _mm512_xor_epi32(va6x0123c0, vsign_mask);
       va7x0123c0 = _mm512_xor_epi32(va7x0123c0, vsign_mask);
       ...
       vacc6x0123456789ABCDEF = _mm512_dpbusd_epi32(vacc6x0123456789ABCDEF, va6x0123c0, vb0123456789ABCDEFc0);
       vacc7x0123456789ABCDEF = _mm512_dpbusd_epi32(vacc7x0123456789ABCDEF, va7x0123c0, vb0123456789ABCDEFc0);
       ...
       a5 += 4;
       __m512i va6x0123c1 = _mm512_set1_epi32((int) unaligned_load_u32(a6));
       a6 += 4;
       __m512i va7x0123c1 = _mm512_set1_epi32((int) unaligned_load_u32(a7));
       a7 += 4;
       ...
       va6x0123c1 = _mm512_xor_epi32(va6x0123c1, vsign_mask);
       va7x0123c1 = _mm512_xor_epi32(va7x0123c1, vsign_mask);
       ...
       vacc6x0123456789ABCDEF = _mm512_dpbusd_epi32(vacc6x0123456789ABCDEF, va6x0123c1, vb0123456789ABCDEFc1);
       vacc7x0123456789ABCDEF = _mm512_dpbusd_epi32(vacc7x0123456789ABCDEF, va7x0123c1, vb0123456789ABCDEFc1);
