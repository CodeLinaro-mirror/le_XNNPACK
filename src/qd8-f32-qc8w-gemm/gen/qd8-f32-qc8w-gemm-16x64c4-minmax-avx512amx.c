...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_16x64c4__avx512amx(
    size_t mr,
    size_t nc,
    size_t kc,
...
// Update if amxintrin changes
  ...
  do {
    ...
    __m512i vacc7xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[7].zero_point));
    ...
    __m512i vacc8xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[8].zero_point));
    ...
    __m512i vacc9xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[9].zero_point));
    ...
    __m512i vacc10xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[10].zero_point));
    ...
    __m512i vacc11xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[11].zero_point));
    ...
    __m512i vacc12xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[12].zero_point));
    ...
    __m512i vacc13xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[13].zero_point));
    ...
    __m512i vacc14xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[14].zero_point));
    ...
    __m512i vacc15xmnopqrstuvwxyz = _mm512_mullo_epi32(vksummnopqrstuvwxyz, _mm512_set1_epi32((int) quantization_params[15].zero_point));
    ...
    vacc7xmnopqrstuvwxyz = _mm512_add_epi32(vacc7xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 112));
    ...
    vacc8xmnopqrstuvwxyz = _mm512_add_epi32(vacc8xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 128));
    ...
    vacc9xmnopqrstuvwxyz = _mm512_add_epi32(vacc9xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 144));
    ...
    vacc10xmnopqrstuvwxyz = _mm512_add_epi32(vacc10xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 160));
    ...
    vacc11xmnopqrstuvwxyz = _mm512_add_epi32(vacc11xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 176));
    ...
    vacc12xmnopqrstuvwxyz = _mm512_add_epi32(vacc12xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 192));
    ...
    vacc13xmnopqrstuvwxyz = _mm512_add_epi32(vacc13xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 208));
    ...
    vacc14xmnopqrstuvwxyz = _mm512_add_epi32(vacc14xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 224));
    ...
    vacc15xmnopqrstuvwxyz = _mm512_add_epi32(vacc15xmnopqrstuvwxyz, _mm512_load_epi32(res3 + 240));
    ...
    __m512 vscaled7xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc7xmnopqrstuvwxyz);
    ...
    __m512 vscaled8xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc8xmnopqrstuvwxyz);
    ...
    __m512 vscaled9xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc9xmnopqrstuvwxyz);
    ...
    __m512 vscaled10xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc10xmnopqrstuvwxyz);
    ...
    __m512 vscaled11xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc11xmnopqrstuvwxyz);
    ...
    __m512 vscaled12xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc12xmnopqrstuvwxyz);
    ...
    __m512 vscaled13xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc13xmnopqrstuvwxyz);
    ...
    __m512 vscaled14xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc14xmnopqrstuvwxyz);
    ...
    __m512 vscaled15xmnopqrstuvwxyz = _mm512_cvtepi32_ps(vacc15xmnopqrstuvwxyz);
    ...
    vscaled7xmnopqrstuvwxyz = _mm512_mul_ps(vscaled7xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[7].inv_scale));
    ...
    vscaled8xmnopqrstuvwxyz = _mm512_mul_ps(vscaled8xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[8].inv_scale));
    ...
    vscaled9xmnopqrstuvwxyz = _mm512_mul_ps(vscaled9xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[9].inv_scale));
    ...
    vscaled10xmnopqrstuvwxyz = _mm512_mul_ps(vscaled10xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[10].inv_scale));
    ...
    vscaled11xmnopqrstuvwxyz = _mm512_mul_ps(vscaled11xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[11].inv_scale));
    ...
    vscaled12xmnopqrstuvwxyz = _mm512_mul_ps(vscaled12xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[12].inv_scale));
    ...
    vscaled13xmnopqrstuvwxyz = _mm512_mul_ps(vscaled13xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[13].inv_scale));
    ...
    vscaled14xmnopqrstuvwxyz = _mm512_mul_ps(vscaled14xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[14].inv_scale));
    ...
    vscaled15xmnopqrstuvwxyz = _mm512_mul_ps(vscaled15xmnopqrstuvwxyz, _mm512_set1_ps(quantization_params[15].inv_scale));
    ...
    vscaled7xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled7xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled8xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled8xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled9xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled9xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled10xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled10xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled11xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled11xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled12xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled12xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled13xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled13xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled14xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled14xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled15xmnopqrstuvwxyz = _mm512_fmadd_ps(vscaled15xmnopqrstuvwxyz, vfilter_output_scalemnopqrstuvwxyz, vbiasmnopqrstuvwxyz);
    ...
    vscaled7xmnopqrstuvwxyz = _mm512_max_ps(vscaled7xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled8xmnopqrstuvwxyz = _mm512_max_ps(vscaled8xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled9xmnopqrstuvwxyz = _mm512_max_ps(vscaled9xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled10xmnopqrstuvwxyz = _mm512_max_ps(vscaled10xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled11xmnopqrstuvwxyz = _mm512_max_ps(vscaled11xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled12xmnopqrstuvwxyz = _mm512_max_ps(vscaled12xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled13xmnopqrstuvwxyz = _mm512_max_ps(vscaled13xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled14xmnopqrstuvwxyz = _mm512_max_ps(vscaled14xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled15xmnopqrstuvwxyz = _mm512_max_ps(vscaled15xmnopqrstuvwxyz, voutput_min);
    ...
    vscaled7xmnopqrstuvwxyz = _mm512_min_ps(vscaled7xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled8xmnopqrstuvwxyz = _mm512_min_ps(vscaled8xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled9xmnopqrstuvwxyz = _mm512_min_ps(vscaled9xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled10xmnopqrstuvwxyz = _mm512_min_ps(vscaled10xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled11xmnopqrstuvwxyz = _mm512_min_ps(vscaled11xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled12xmnopqrstuvwxyz = _mm512_min_ps(vscaled12xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled13xmnopqrstuvwxyz = _mm512_min_ps(vscaled13xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled14xmnopqrstuvwxyz = _mm512_min_ps(vscaled14xmnopqrstuvwxyz, voutput_max);
    ...
    vscaled15xmnopqrstuvwxyz = _mm512_min_ps(vscaled15xmnopqrstuvwxyz, voutput_max);
    ...
    if XNN_LIKELY(nc >= 64) {
      ...
      _mm512_storeu_ps(c15 + 48, vscaled15xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c14 + 48, vscaled14xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c13 + 48, vscaled13xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c12 + 48, vscaled12xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c11 + 48, vscaled11xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c10 + 48, vscaled10xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c9 + 48, vscaled9xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c8 + 48, vscaled8xmnopqrstuvwxyz);
      ...
      _mm512_storeu_ps(c7 + 48, vscaled7xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c15 + 48, vmask3, vscaled15xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c14 + 48, vmask3, vscaled14xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c13 + 48, vmask3, vscaled13xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c12 + 48, vmask3, vscaled12xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c11 + 48, vmask3, vscaled11xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c10 + 48, vmask3, vscaled10xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c9 + 48, vmask3, vscaled9xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c8 + 48, vmask3, vscaled8xmnopqrstuvwxyz);
      ...
      _mm512_mask_storeu_ps(c7 + 48, vmask3, vscaled7xmnopqrstuvwxyz);
