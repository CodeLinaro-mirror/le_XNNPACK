...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_8x8c4__avxvnni_u1(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256i vacc5x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point5);
    __m256i vacc6x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point6);
    __m256i vacc7x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point7);
    w = (const int32_t*) w + 8;
    ...
    while (k != 0) {
      ...
      vacc0x01234567 = MM256_DPBUSD_EPI32(vacc0x01234567, va0x0123, vb01234567);
      vacc1x01234567 = MM256_DPBUSD_EPI32(vacc1x01234567, va1x0123, vb01234567);
      vacc2x01234567 = MM256_DPBUSD_EPI32(vacc2x01234567, va2x0123, vb01234567);
      vacc3x01234567 = MM256_DPBUSD_EPI32(vacc3x01234567, va3x0123, vb01234567);
      vacc4x01234567 = MM256_DPBUSD_EPI32(vacc4x01234567, va4x0123, vb01234567);
      vacc5x01234567 = MM256_DPBUSD_EPI32(vacc5x01234567, va5x0123, vb01234567);
      vacc6x01234567 = MM256_DPBUSD_EPI32(vacc6x01234567, va6x0123, vb01234567);
      vacc7x01234567 = MM256_DPBUSD_EPI32(vacc7x01234567, va7x0123, vb01234567);
