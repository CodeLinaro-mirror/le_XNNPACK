...
void xnn_qd8_f32_qs8w_gemm_minmax_ukernel_6x16__neon_mlal_lane_prfm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    int32x4_t vksum0123 = vld1q_s32(w); w = (const void*) ((const int32_t*) w + 4);
    int32x4_t vksum4567 = vld1q_s32(w); w = (const void*) ((const int32_t*) w + 4);
    int32x4_t vksum89AB = vld1q_s32(w); w = (const void*) ((const int32_t*) w + 4);
    int32x4_t vksumCDEF = vld1q_s32(w); w = (const void*) ((const int32_t*) w + 4);
    ...
    #endif
    #if XNN_ARCH_ARM64
      vout4x89AB = vfmaq_lane_f32(vbias89AB, vout4x89AB, vget_low_f32(vscale45), 1);
      vout5x89AB = vfmaq_lane_f32(vbias89AB, vout5x89AB, vget_high_f32(vscale45), 1);
    #else
      vout4x89AB = vmlaq_lane_f32(vbias89AB, vout4x89AB, vget_low_f32(vscale45), 1);
      vout5x89AB = vmlaq_lane_f32(vbias89AB, vout5x89AB, vget_high_f32(vscale45), 1);
    #endif
    #if XNN_ARCH_ARM64
      vout4xCDEF = vfmaq_lane_f32(vbiasCDEF, vout4xCDEF, vget_low_f32(vscale45), 1);
      vout5xCDEF = vfmaq_lane_f32(vbiasCDEF, vout5xCDEF, vget_high_f32(vscale45), 1);
    #else
      vout4xCDEF = vmlaq_lane_f32(vbiasCDEF, vout4xCDEF, vget_low_f32(vscale45), 1);
      vout5xCDEF = vmlaq_lane_f32(vbiasCDEF, vout5xCDEF, vget_high_f32(vscale45), 1);
    #endif
    ...
    vout4x89AB = vmaxq_f32(vout4x89AB, vmin);
    vout4xCDEF = vmaxq_f32(vout4xCDEF, vmin);
    vout4x0123 = vminq_f32(vout4x0123, vmax);
    vout4x4567 = vminq_f32(vout4x4567, vmax);
    vout4x89AB = vminq_f32(vout4x89AB, vmax);
    vout4xCDEF = vminq_f32(vout4xCDEF, vmax);
    vout5x0123 = vmaxq_f32(vout5x0123, vmin);
    vout5x4567 = vmaxq_f32(vout5x4567, vmin);
    vout5x89AB = vmaxq_f32(vout5x89AB, vmin);
    vout5xCDEF = vmaxq_f32(vout5xCDEF, vmin);
    vout5x0123 = vminq_f32(vout5x0123, vmax);
    vout5x4567 = vminq_f32(vout5x4567, vmax);
    vout5x89AB = vminq_f32(vout5x89AB, vmax);
    vout5xCDEF = vminq_f32(vout5xCDEF, vmax);
    if XNN_LIKELY(nc >= 16) {
