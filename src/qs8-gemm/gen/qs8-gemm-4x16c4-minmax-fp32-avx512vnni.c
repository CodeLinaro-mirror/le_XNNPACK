    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m512i voutput_zero_point = _mm512_load_epi32(params->fp32_avx512vnni.output_zero_point);
  ...
  do {
    ...
    size_t k = kc;
    do {
      __m512i va0x0123 = _mm512_set1_epi32((int32_t)unaligned_load_u32(a0));
      __m512i va1x0123 = _mm512_set1_epi32((int32_t)unaligned_load_u32(a1));
      __m512i va2x0123 = _mm512_set1_epi32((int32_t)unaligned_load_u32(a2));
      __m512i va3x0123 = _mm512_set1_epi32((int32_t)unaligned_load_u32(a3));
    ...
    const __m256i vacc0x0123456789ABCDEF_w = _mm256_packs_epi32(_mm512_castsi512_si256(vacc0x0123456789ABCDEF), _mm512_extracti32x8_epi32(vacc0x0123456789ABCDEF, 1));
    const __m256i vacc1x0123456789ABCDEF_w = _mm256_packs_epi32(_mm512_castsi512_si256(vacc1x0123456789ABCDEF), _mm512_extracti32x8_epi32(vacc1x0123456789ABCDEF, 1));
    const __m256i vacc2x0123456789ABCDEF_w = _mm256_packs_epi32(_mm512_castsi512_si256(vacc2x0123456789ABCDEF), _mm512_extracti32x8_epi32(vacc2x0123456789ABCDEF, 1));
    const __m256i vacc3x0123456789ABCDEF_w = _mm256_packs_epi32(_mm512_castsi512_si256(vacc3x0123456789ABCDEF), _mm512_extracti32x8_epi32(vacc3x0123456789ABCDEF, 1));

    const __m128i vout0x012389AB4567CDEF = _mm_packs_epi16(_mm256_castsi256_si128(vacc0x0123456789ABCDEF_w), _mm256_extracti128_si256(vacc0x0123456789ABCDEF_w, 1));
    const __m128i vout1x012389AB4567CDEF = _mm_packs_epi16(_mm256_castsi256_si128(vacc1x0123456789ABCDEF_w), _mm256_extracti128_si256(vacc1x0123456789ABCDEF_w, 1));
    const __m128i vout2x012389AB4567CDEF = _mm_packs_epi16(_mm256_castsi256_si128(vacc2x0123456789ABCDEF_w), _mm256_extracti128_si256(vacc2x0123456789ABCDEF_w, 1));
    const __m128i vout3x012389AB4567CDEF = _mm_packs_epi16(_mm256_castsi256_si128(vacc3x0123456789ABCDEF_w), _mm256_extracti128_si256(vacc3x0123456789ABCDEF_w, 1));
    ...
    __m128i vout2x0123456789ABCDEF = _mm_shuffle_epi8(vout2x012389AB4567CDEF, _mm_loadu_epi8(params->fp32_avx512vnni.shuffle_control_mask));
    __m128i vout3x0123456789ABCDEF = _mm_shuffle_epi8(vout3x012389AB4567CDEF, _mm_loadu_epi8(params->fp32_avx512vnni.shuffle_control_mask));
