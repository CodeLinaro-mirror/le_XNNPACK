...
void xnn_qs8_gemm_minmax_rndnu_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    int32x4_t vacc01x01 = vreinterpretq_u64_s32(vbias01x0123.val[0]);
    int32x4_t vacc01x23 = vreinterpretq_u64_s32(vbias01x0123.val[1]);
    int32x4_t vacc01x45 = vreinterpretq_u64_s32(vbias01x4567.val[0]);
    int32x4_t vacc01x67 = vreinterpretq_u64_s32(vbias01x4567.val[1]);
    int32x4_t vacc01x89 = vreinterpretq_u64_s32(vbias01x89AB.val[0]);
    int32x4_t vacc01xAB = vreinterpretq_u64_s32(vbias01x89AB.val[1]);
    int32x4_t vacc01xCD = vreinterpretq_u64_s32(vbias01xCDEF.val[0]);
    int32x4_t vacc01xEF = vreinterpretq_u64_s32(vbias01xCDEF.val[1]);
    int32x4_t vacc23x01 = vreinterpretq_u64_s32(vbias01x0123.val[0]);
    int32x4_t vacc23x23 = vreinterpretq_u64_s32(vbias01x0123.val[1]);
    int32x4_t vacc23x45 = vreinterpretq_u64_s32(vbias01x4567.val[0]);
    int32x4_t vacc23x67 = vreinterpretq_u64_s32(vbias01x4567.val[1]);
    int32x4_t vacc23x89 = vreinterpretq_u64_s32(vbias01x89AB.val[0]);
    int32x4_t vacc23xAB = vreinterpretq_u64_s32(vbias01x89AB.val[1]);
    int32x4_t vacc23xCD = vreinterpretq_u64_s32(vbias01xCDEF.val[0]);
    int32x4_t vacc23xEF = vreinterpretq_u64_s32(vbias01xCDEF.val[1]);
    int32x4_t vacc45x01 = vreinterpretq_u64_s32(vbias01x0123.val[0]);
    int32x4_t vacc45x23 = vreinterpretq_u64_s32(vbias01x0123.val[1]);
    int32x4_t vacc45x45 = vreinterpretq_u64_s32(vbias01x4567.val[0]);
    int32x4_t vacc45x67 = vreinterpretq_u64_s32(vbias01x4567.val[1]);
    int32x4_t vacc45x89 = vreinterpretq_u64_s32(vbias01x89AB.val[0]);
    int32x4_t vacc45xAB = vreinterpretq_u64_s32(vbias01x89AB.val[1]);
    int32x4_t vacc45xCD = vreinterpretq_u64_s32(vbias01xCDEF.val[0]);
    int32x4_t vacc45xEF = vreinterpretq_u64_s32(vbias01xCDEF.val[1]);
    int32x4_t vacc67x01 = vreinterpretq_u64_s32(vbias01x0123.val[0]);
    int32x4_t vacc67x23 = vreinterpretq_u64_s32(vbias01x0123.val[1]);
    int32x4_t vacc67x45 = vreinterpretq_u64_s32(vbias01x4567.val[0]);
    int32x4_t vacc67x67 = vreinterpretq_u64_s32(vbias01x4567.val[1]);
    int32x4_t vacc67x89 = vreinterpretq_u64_s32(vbias01x89AB.val[0]);
    int32x4_t vacc67xAB = vreinterpretq_u64_s32(vbias01x89AB.val[1]);
    int32x4_t vacc67xCD = vreinterpretq_u64_s32(vbias01xCDEF.val[0]);
    int32x4_t vacc67xEF = vreinterpretq_u64_s32(vbias01xCDEF.val[1]);
    ...
    vacc6x89AB = vqshlq_s32(vacc6x89AB, vright_pre_shift);
    vacc6xCDEF = vqshlq_s32(vacc6xCDEF, vright_pre_shift);
    vacc7x0123 = vqshlq_s32(vacc7x0123, vright_pre_shift);
    vacc7x4567 = vqshlq_s32(vacc7x4567, vright_pre_shift);
    vacc7x89AB = vqshlq_s32(vacc7x89AB, vright_pre_shift);
    vacc7xCDEF = vqshlq_s32(vacc7xCDEF, vright_pre_shift);
