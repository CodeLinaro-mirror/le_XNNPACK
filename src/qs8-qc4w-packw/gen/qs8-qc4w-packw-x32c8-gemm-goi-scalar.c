  ...
  const struct xnn_qs8_qc4w_packing_params* params)
{
  ...
  do {
    ...
    do {
      const size_t nr_block_size = min(nc - nr_block_start, 32);
      ...
      packed_weights = (int32_t*) packed_weights + 32;
      ...
      for (size_t kr_block_start = 0; kr_block_start < round_up_po2(kc, skr * 2); kr_block_start += 8 * 2) {
        ...
        packed_weights = (uint8_t*) packed_weights + (32 - nr_block_size) * 8;  // skip NR remainder
      }
