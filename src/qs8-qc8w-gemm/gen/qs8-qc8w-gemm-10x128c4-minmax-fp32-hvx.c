...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_10x128c4__hvx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params* restrict params) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; k >= 4 * sizeof(int8_t); k -= 4 * sizeof(int8_t)) {
      ...
      vacc8x3 = Q6_Vw_vrmpyacc_VwVbVb(vacc8x3, va8x0123, vb3x0123);
      ...
      vacc9x3 = Q6_Vw_vrmpyacc_VwVbVb(vacc9x3, va9x0123, vb3x0123);
    }
    ...
    vacc8x3 = rescale_fp32(vacc8x3, vscale3);
    vacc9x3 = rescale_fp32(vacc9x3, vscale3);
    ...
    HVX_Vector vout8x1 = Q6_Vh_vpack_VwVw_sat(vacc8x3, vacc8x2);
    HVX_Vector vout9x0 = Q6_Vh_vpack_VwVw_sat(vacc9x1, vacc9x0);
    HVX_Vector vout9x1 = Q6_Vh_vpack_VwVw_sat(vacc9x3, vacc9x2);
