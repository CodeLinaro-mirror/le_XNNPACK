...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_5x8c8__avx256skx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256i vacc44x01234567 = _mm256_adds_epi16(_mm256_packs_epi32(vacc4x01234567, vacc4x01234567), voutput_zero_point);
    ...
    vacc44x01234567 = _mm256_permute4x64_epi64(vacc44x01234567, _MM_SHUFFLE(3, 1, 2, 0));
