...
void xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_8x8c8__avx256skx(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qs8_qc8w_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    __m256 vfpacc4x01234567 = _mm256_cvtepi32_ps(vacc4x01234567);
    __m256 vfpacc5x01234567 = _mm256_cvtepi32_ps(vacc5x01234567);
    __m256 vfpacc6x01234567 = _mm256_cvtepi32_ps(vacc6x01234567);
    __m256 vfpacc7x01234567 = _mm256_cvtepi32_ps(vacc7x01234567);
    ...
    vfpacc4x01234567 = _mm256_mul_ps(vfpacc4x01234567, vscale01234567);
    vfpacc5x01234567 = _mm256_mul_ps(vfpacc5x01234567, vscale01234567);
    vfpacc6x01234567 = _mm256_mul_ps(vfpacc6x01234567, vscale01234567);
    vfpacc7x01234567 = _mm256_mul_ps(vfpacc7x01234567, vscale01234567);
    ...
    vfpacc4x01234567 = _mm256_min_ps(vfpacc4x01234567, voutput_max_less_zero_point);
    vfpacc5x01234567 = _mm256_min_ps(vfpacc5x01234567, voutput_max_less_zero_point);
    vfpacc6x01234567 = _mm256_min_ps(vfpacc6x01234567, voutput_max_less_zero_point);
    vfpacc7x01234567 = _mm256_min_ps(vfpacc7x01234567, voutput_max_less_zero_point);
    ...
    vacc4x01234567 = _mm256_cvtps_epi32(vfpacc4x01234567);
    vacc5x01234567 = _mm256_cvtps_epi32(vfpacc5x01234567);
    vacc6x01234567 = _mm256_cvtps_epi32(vfpacc6x01234567);
    vacc7x01234567 = _mm256_cvtps_epi32(vfpacc7x01234567);
