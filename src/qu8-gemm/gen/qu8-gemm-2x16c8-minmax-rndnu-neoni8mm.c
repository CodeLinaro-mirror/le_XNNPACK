...
void xnn_qu8_gemm_minmax_rndnu_ukernel_2x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    uint32x4_t vpacc1_01x01 = vdupq_n_u32(0);
    uint32x4_t vpacc1_01x23 = vdupq_n_u32(0);
    ...
    uint32x4_t vpacc1_01x45 = vdupq_n_u32(0);
    uint32x4_t vpacc1_01x67 = vdupq_n_u32(0);
    ...
    uint32x4_t vpacc1_01x89 = vdupq_n_u32(0);
    uint32x4_t vpacc1_01xAB = vdupq_n_u32(0);
    ...
    uint32x4_t vpacc1_01xCD = vdupq_n_u32(0);
    uint32x4_t vpacc1_01xEF = vdupq_n_u32(0);
    ...
    while (k >= 16 * sizeof(uint8_t)) {
      ...
      vpacc1_01x01 = vmmlaq_u32(vpacc1_01x01, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb01x89ABCDEF);
      vpacc1_01x23 = vmmlaq_u32(vpacc1_01x23, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb23x89ABCDEF);
      vpacc1_01x45 = vmmlaq_u32(vpacc1_01x45, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb45x89ABCDEF);
      vpacc1_01x67 = vmmlaq_u32(vpacc1_01x67, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb67x89ABCDEF);
      vpacc1_01x89 = vmmlaq_u32(vpacc1_01x89, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb89x89ABCDEF);
      vpacc1_01xAB = vmmlaq_u32(vpacc1_01xAB, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
      vpacc1_01xCD = vmmlaq_u32(vpacc1_01xCD, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
      vpacc1_01xEF = vmmlaq_u32(vpacc1_01xEF, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
    ...
    vpacc0_01x01 = vaddq_u32(vpacc0_01x01, vpacc1_01x01);
    vpacc0_01x23 = vaddq_u32(vpacc0_01x23, vpacc1_01x23);
    vpacc0_01x45 = vaddq_u32(vpacc0_01x45, vpacc1_01x45);
    vpacc0_01x67 = vaddq_u32(vpacc0_01x67, vpacc1_01x67);
    vpacc0_01x89 = vaddq_u32(vpacc0_01x89, vpacc1_01x89);
    vpacc0_01xAB = vaddq_u32(vpacc0_01xAB, vpacc1_01xAB);
    vpacc0_01xCD = vaddq_u32(vpacc0_01xCD, vpacc1_01xCD);
    vpacc0_01xEF = vaddq_u32(vpacc0_01xEF, vpacc1_01xEF);
