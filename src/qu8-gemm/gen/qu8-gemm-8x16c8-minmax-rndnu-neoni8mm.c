...
void xnn_qu8_gemm_minmax_rndnu_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    uint32x4_t vpacc0_01x01 = vreinterpretq_u32_u64(vbias01x0123.val[0]);
    uint32x4_t vpacc0_01x23 = vreinterpretq_u32_u64(vbias01x0123.val[1]);
    uint32x4_t vpacc0_01x45 = vreinterpretq_u32_u64(vbias01x4567.val[0]);
    uint32x4_t vpacc0_01x67 = vreinterpretq_u32_u64(vbias01x4567.val[1]);
    uint32x4_t vpacc0_01x89 = vreinterpretq_u32_u64(vbias01x89AB.val[0]);
    uint32x4_t vpacc0_01xAB = vreinterpretq_u32_u64(vbias01x89AB.val[1]);
    uint32x4_t vpacc0_01xCD = vreinterpretq_u32_u64(vbias01xCDEF.val[0]);
    uint32x4_t vpacc0_01xEF = vreinterpretq_u32_u64(vbias01xCDEF.val[1]);
    uint32x4_t vpacc0_23x01 = vreinterpretq_u32_u64(vbias01x0123.val[0]);
    uint32x4_t vpacc0_23x23 = vreinterpretq_u32_u64(vbias01x0123.val[1]);
    uint32x4_t vpacc0_23x45 = vreinterpretq_u32_u64(vbias01x4567.val[0]);
    uint32x4_t vpacc0_23x67 = vreinterpretq_u32_u64(vbias01x4567.val[1]);
    uint32x4_t vpacc0_23x89 = vreinterpretq_u32_u64(vbias01x89AB.val[0]);
    uint32x4_t vpacc0_23xAB = vreinterpretq_u32_u64(vbias01x89AB.val[1]);
    uint32x4_t vpacc0_23xCD = vreinterpretq_u32_u64(vbias01xCDEF.val[0]);
    uint32x4_t vpacc0_23xEF = vreinterpretq_u32_u64(vbias01xCDEF.val[1]);
    uint32x4_t vpacc0_45x01 = vreinterpretq_u32_u64(vbias01x0123.val[0]);
    uint32x4_t vpacc0_45x23 = vreinterpretq_u32_u64(vbias01x0123.val[1]);
    uint32x4_t vpacc0_45x45 = vreinterpretq_u32_u64(vbias01x4567.val[0]);
    uint32x4_t vpacc0_45x67 = vreinterpretq_u32_u64(vbias01x4567.val[1]);
    uint32x4_t vpacc0_45x89 = vreinterpretq_u32_u64(vbias01x89AB.val[0]);
    uint32x4_t vpacc0_45xAB = vreinterpretq_u32_u64(vbias01x89AB.val[1]);
    uint32x4_t vpacc0_45xCD = vreinterpretq_u32_u64(vbias01xCDEF.val[0]);
    uint32x4_t vpacc0_45xEF = vreinterpretq_u32_u64(vbias01xCDEF.val[1]);
    uint32x4_t vpacc0_67x01 = vreinterpretq_u32_u64(vbias01x0123.val[0]);
    uint32x4_t vpacc0_67x23 = vreinterpretq_u32_u64(vbias01x0123.val[1]);
    uint32x4_t vpacc0_67x45 = vreinterpretq_u32_u64(vbias01x4567.val[0]);
    uint32x4_t vpacc0_67x67 = vreinterpretq_u32_u64(vbias01x4567.val[1]);
    uint32x4_t vpacc0_67x89 = vreinterpretq_u32_u64(vbias01x89AB.val[0]);
    uint32x4_t vpacc0_67xAB = vreinterpretq_u32_u64(vbias01x89AB.val[1]);
    uint32x4_t vpacc0_67xCD = vreinterpretq_u32_u64(vbias01xCDEF.val[0]);
    uint32x4_t vpacc0_67xEF = vreinterpretq_u32_u64(vbias01xCDEF.val[1]);
    uint32x4_t vnacc0_01 = vmovq_n_u32(0);
    uint32x4_t vnacc1_01 = vmovq_n_u32(0);
    uint32x4_t vnacc0_23 = vmovq_n_u32(0);
    uint32x4_t vnacc1_23 = vmovq_n_u32(0);
    uint32x4_t vnacc0_45 = vmovq_n_u32(0);
    uint32x4_t vnacc1_45 = vmovq_n_u32(0);
    uint32x4_t vnacc0_67 = vmovq_n_u32(0);
    uint32x4_t vnacc1_67 = vmovq_n_u32(0);
    ...
    while (k >= 16 * sizeof(uint8_t)) {
      ...
      vnacc0_01 = vmmlaq_u32(vnacc0_01, vkernel_zero_point, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]));
      vnacc1_01 = vmmlaq_u32(vnacc1_01, vkernel_zero_point, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]));
      vnacc0_23 = vmmlaq_u32(vnacc0_23, vkernel_zero_point, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]));
      vnacc1_23 = vmmlaq_u32(vnacc1_23, vkernel_zero_point, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]));
      vnacc0_45 = vmmlaq_u32(vnacc0_45, vkernel_zero_point, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]));
      vnacc1_45 = vmmlaq_u32(vnacc1_45, vkernel_zero_point, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]));
      vnacc0_67 = vmmlaq_u32(vnacc0_67, vkernel_zero_point, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]));
      vnacc1_67 = vmmlaq_u32(vnacc1_67, vkernel_zero_point, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]));
      ...
      vpacc0_01x01 = vmmlaq_u32(vpacc0_01x01, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb01x01234567);
      vpacc0_01x23 = vmmlaq_u32(vpacc0_01x23, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb23x01234567);
      vpacc0_01x45 = vmmlaq_u32(vpacc0_01x45, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb45x01234567);
      vpacc0_01x67 = vmmlaq_u32(vpacc0_01x67, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb67x01234567);
      vpacc0_01x89 = vmmlaq_u32(vpacc0_01x89, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb89x01234567);
      vpacc0_01xAB = vmmlaq_u32(vpacc0_01xAB, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb1011x01234567);
      vpacc0_01xCD = vmmlaq_u32(vpacc0_01xCD, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb1213x01234567);
      vpacc0_01xEF = vmmlaq_u32(vpacc0_01xEF, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]), vb1415x01234567);
      vpacc0_23x01 = vmmlaq_u32(vpacc0_23x01, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb01x01234567);
      vpacc0_23x23 = vmmlaq_u32(vpacc0_23x23, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb23x01234567);
      vpacc0_23x45 = vmmlaq_u32(vpacc0_23x45, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb45x01234567);
      vpacc0_23x67 = vmmlaq_u32(vpacc0_23x67, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb67x01234567);
      vpacc0_23x89 = vmmlaq_u32(vpacc0_23x89, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb89x01234567);
      vpacc0_23xAB = vmmlaq_u32(vpacc0_23xAB, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb1011x01234567);
      vpacc0_23xCD = vmmlaq_u32(vpacc0_23xCD, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb1213x01234567);
      vpacc0_23xEF = vmmlaq_u32(vpacc0_23xEF, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]), vb1415x01234567);
      vpacc0_45x01 = vmmlaq_u32(vpacc0_45x01, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb01x01234567);
      vpacc0_45x23 = vmmlaq_u32(vpacc0_45x23, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb23x01234567);
      vpacc0_45x45 = vmmlaq_u32(vpacc0_45x45, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb45x01234567);
      vpacc0_45x67 = vmmlaq_u32(vpacc0_45x67, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb67x01234567);
      vpacc0_45x89 = vmmlaq_u32(vpacc0_45x89, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb89x01234567);
      vpacc0_45xAB = vmmlaq_u32(vpacc0_45xAB, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb1011x01234567);
      vpacc0_45xCD = vmmlaq_u32(vpacc0_45xCD, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb1213x01234567);
      vpacc0_45xEF = vmmlaq_u32(vpacc0_45xEF, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]), vb1415x01234567);
      vpacc0_67x01 = vmmlaq_u32(vpacc0_67x01, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb01x01234567);
      vpacc0_67x23 = vmmlaq_u32(vpacc0_67x23, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb23x01234567);
      vpacc0_67x45 = vmmlaq_u32(vpacc0_67x45, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb45x01234567);
      vpacc0_67x67 = vmmlaq_u32(vpacc0_67x67, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb67x01234567);
      vpacc0_67x89 = vmmlaq_u32(vpacc0_67x89, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb89x01234567);
      vpacc0_67xAB = vmmlaq_u32(vpacc0_67xAB, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb1011x01234567);
      vpacc0_67xCD = vmmlaq_u32(vpacc0_67xCD, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb1213x01234567);
      vpacc0_67xEF = vmmlaq_u32(vpacc0_67xEF, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]), vb1415x01234567);
      vpacc0_01x01 = vmmlaq_u32(vpacc0_01x01, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb01x89ABCDEF);
      vpacc0_01x23 = vmmlaq_u32(vpacc0_01x23, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb23x89ABCDEF);
      vpacc0_01x45 = vmmlaq_u32(vpacc0_01x45, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb45x89ABCDEF);
      vpacc0_01x67 = vmmlaq_u32(vpacc0_01x67, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb67x89ABCDEF);
      vpacc0_01x89 = vmmlaq_u32(vpacc0_01x89, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb89x89ABCDEF);
      vpacc0_01xAB = vmmlaq_u32(vpacc0_01xAB, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
      vpacc0_01xCD = vmmlaq_u32(vpacc0_01xCD, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
      vpacc0_01xEF = vmmlaq_u32(vpacc0_01xEF, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
      vpacc0_23x01 = vmmlaq_u32(vpacc0_23x01, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb01x89ABCDEF);
      vpacc0_23x23 = vmmlaq_u32(vpacc0_23x23, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb23x89ABCDEF);
      vpacc0_23x45 = vmmlaq_u32(vpacc0_23x45, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb45x89ABCDEF);
      vpacc0_23x67 = vmmlaq_u32(vpacc0_23x67, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb67x89ABCDEF);
      vpacc0_23x89 = vmmlaq_u32(vpacc0_23x89, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb89x89ABCDEF);
      vpacc0_23xAB = vmmlaq_u32(vpacc0_23xAB, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
      vpacc0_23xCD = vmmlaq_u32(vpacc0_23xCD, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
      vpacc0_23xEF = vmmlaq_u32(vpacc0_23xEF, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
      vpacc0_45x01 = vmmlaq_u32(vpacc0_45x01, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb01x89ABCDEF);
      vpacc0_45x23 = vmmlaq_u32(vpacc0_45x23, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb23x89ABCDEF);
      vpacc0_45x45 = vmmlaq_u32(vpacc0_45x45, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb45x89ABCDEF);
      vpacc0_45x67 = vmmlaq_u32(vpacc0_45x67, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb67x89ABCDEF);
      vpacc0_45x89 = vmmlaq_u32(vpacc0_45x89, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb89x89ABCDEF);
      vpacc0_45xAB = vmmlaq_u32(vpacc0_45xAB, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
      vpacc0_45xCD = vmmlaq_u32(vpacc0_45xCD, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
      vpacc0_45xEF = vmmlaq_u32(vpacc0_45xEF, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
      vpacc0_67x01 = vmmlaq_u32(vpacc0_67x01, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb01x89ABCDEF);
      vpacc0_67x23 = vmmlaq_u32(vpacc0_67x23, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb23x89ABCDEF);
      vpacc0_67x45 = vmmlaq_u32(vpacc0_67x45, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb45x89ABCDEF);
      vpacc0_67x67 = vmmlaq_u32(vpacc0_67x67, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb67x89ABCDEF);
      vpacc0_67x89 = vmmlaq_u32(vpacc0_67x89, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb89x89ABCDEF);
      vpacc0_67xAB = vmmlaq_u32(vpacc0_67xAB, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb1011x89ABCDEF);
      vpacc0_67xCD = vmmlaq_u32(vpacc0_67xCD, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb1213x89ABCDEF);
      vpacc0_67xEF = vmmlaq_u32(vpacc0_67xEF, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]), vb1415x89ABCDEF);
    ...
    vnacc0_01 = vaddq_u32(vnacc0_01, vnacc1_01);
    vnacc0_23 = vaddq_u32(vnacc0_23, vnacc1_23);
    vnacc0_45 = vaddq_u32(vnacc0_45, vnacc1_45);
    vnacc0_67 = vaddq_u32(vnacc0_67, vnacc1_67);
    // Subtract zero point from accumulators.
    const uint32x4_t vnacc01x01 = vzip1q_u32(vnacc0_01, vnacc0_01);
    int32x4_t vacc01x01 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01x01, vnacc01x01));
    int32x4_t vacc01x23 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01x23, vnacc01x01));
    int32x4_t vacc01x45 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01x45, vnacc01x01));
    int32x4_t vacc01x67 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01x67, vnacc01x01));
    int32x4_t vacc01x89 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01x89, vnacc01x01));
    int32x4_t vacc01xAB = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01xAB, vnacc01x01));
    int32x4_t vacc01xCD = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01xCD, vnacc01x01));
    int32x4_t vacc01xEF = vreinterpretq_s32_u32(vsubq_u32(vpacc0_01xEF, vnacc01x01));
    const uint32x4_t vnacc23x01 = vzip1q_u32(vnacc0_23, vnacc0_23);
    int32x4_t vacc23x01 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23x01, vnacc23x01));
    int32x4_t vacc23x23 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23x23, vnacc23x01));
    int32x4_t vacc23x45 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23x45, vnacc23x01));
    int32x4_t vacc23x67 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23x67, vnacc23x01));
    int32x4_t vacc23x89 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23x89, vnacc23x01));
    int32x4_t vacc23xAB = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23xAB, vnacc23x01));
    int32x4_t vacc23xCD = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23xCD, vnacc23x01));
    int32x4_t vacc23xEF = vreinterpretq_s32_u32(vsubq_u32(vpacc0_23xEF, vnacc23x01));
    const uint32x4_t vnacc45x01 = vzip1q_u32(vnacc0_45, vnacc0_45);
    int32x4_t vacc45x01 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45x01, vnacc45x01));
    int32x4_t vacc45x23 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45x23, vnacc45x01));
    int32x4_t vacc45x45 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45x45, vnacc45x01));
    int32x4_t vacc45x67 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45x67, vnacc45x01));
    int32x4_t vacc45x89 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45x89, vnacc45x01));
    int32x4_t vacc45xAB = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45xAB, vnacc45x01));
    int32x4_t vacc45xCD = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45xCD, vnacc45x01));
    int32x4_t vacc45xEF = vreinterpretq_s32_u32(vsubq_u32(vpacc0_45xEF, vnacc45x01));
    const uint32x4_t vnacc67x01 = vzip1q_u32(vnacc0_67, vnacc0_67);
    int32x4_t vacc67x01 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67x01, vnacc67x01));
    int32x4_t vacc67x23 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67x23, vnacc67x01));
    int32x4_t vacc67x45 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67x45, vnacc67x01));
    int32x4_t vacc67x67 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67x67, vnacc67x01));
    int32x4_t vacc67x89 = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67x89, vnacc67x01));
    int32x4_t vacc67xAB = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67xAB, vnacc67x01));
    int32x4_t vacc67xCD = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67xCD, vnacc67x01));
    int32x4_t vacc67xEF = vreinterpretq_s32_u32(vsubq_u32(vpacc0_67xEF, vnacc67x01));
