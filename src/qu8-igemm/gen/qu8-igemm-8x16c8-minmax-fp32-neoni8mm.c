...
void xnn_qu8_igemm_minmax_fp32_ukernel_8x16c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_qu8_conv_minmax_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const uint8x16_t va_zero_point = vld1q_dup_u8(&params->fp32_neonv8.kernel_zero_point[0]);
  ...
  do {
    ...
    do {
      ...
      while (k >= 16 * sizeof(uint8_t)) {
        ...
        const int8x16_t vb01x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb23x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb45x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb67x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb89x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb1011x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb1213x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb1415x01234567 = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb01x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb23x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb45x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb67x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb89x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb1011x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb1213x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;
        const int8x16_t vb1415x89ABCDEF = vld1q_u8(w); w = (const int8_t*) w + 16;

        // Multiply-accumulate: 8x16 * 16x16 --> 8x16.
        vnacc0 = vmmlaq_u32(vnacc0, va_zero_point, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[0]));
        vnacc0 = vmmlaq_u32(vnacc0, va_zero_point, vreinterpretq_u8_u64(va01x0123456789ABCDEF.val[1]));
        vnacc2 = vmmlaq_u32(vnacc2, va_zero_point, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[0]));
        vnacc2 = vmmlaq_u32(vnacc2, va_zero_point, vreinterpretq_u8_u64(va23x0123456789ABCDEF.val[1]));
        vnacc4 = vmmlaq_u32(vnacc4, va_zero_point, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[0]));
        vnacc4 = vmmlaq_u32(vnacc4, va_zero_point, vreinterpretq_u8_u64(va45x0123456789ABCDEF.val[1]));
        vnacc6 = vmmlaq_u32(vnacc6, va_zero_point, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[0]));
        vnacc6 = vmmlaq_u32(vnacc6, va_zero_point, vreinterpretq_u8_u64(va67x0123456789ABCDEF.val[1]));
    ...
    const uint32x4_t vnacc01x01 = vzip1q_u32(vnacc0, vnacc0);
    ...
    const uint32x4_t vnacc23x01 = vzip1q_u32(vnacc2, vnacc2);
    ...
    const uint32x4_t vnacc45x01 = vzip1q_u32(vnacc4, vnacc4);
    ...
    const uint32x4_t vnacc67x01 = vzip1q_u32(vnacc6, vnacc6);
