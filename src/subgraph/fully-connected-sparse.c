  ...
  struct xnn_weights_cache* weights_cache)
{
  ...
  switch (node->compute_type) {
    case xnn_compute_type_fp16:
    {
      status = xnn_create_convolution2d_nchw_f16(
        0 /* input_padding_top */,
        0 /* input_padding_right */,
        0 /* input_padding_bottom */,
        0 /* input_padding_left */,
        1 /* kernel_height */,
        1 /* kernel_width */,
        1 /* subsampling_height */,
        1 /* subsampling_width */,
        1 /* dilation_height */,
        1 /* dilation_width */,
        1 /* groups */,
  ...
  if (status == xnn_status_success) {
    ...
    opdata->input_height = 1;
    opdata->input_width = values[input_id].shape.dim[1];
  }
  return status;
}
