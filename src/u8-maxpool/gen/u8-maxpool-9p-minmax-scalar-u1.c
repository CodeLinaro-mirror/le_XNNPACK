...
void xnn_u8_maxpool_minmax_ukernel_9p__scalar_u1(
    ...
    const struct xnn_u8_minmax_params* restrict params)
{
  ...
  do {
    ...
    size_t c = channels;
    for (; c >= 1; c -= 1) {
      const xnn_simd_u8_t vi0 = xnn_load_impl(i0); i0 += 1;
      const xnn_simd_u8_t vi1 = xnn_load_impl(i1); i1 += 1;
      const xnn_simd_u8_t vi2 = xnn_load_impl(i2); i2 += 1;
      const xnn_simd_u8_t vi3 = xnn_load_impl(i3); i3 += 1;
      const xnn_simd_u8_t vi4 = xnn_load_impl(i4); i4 += 1;
      const xnn_simd_u8_t vi5 = xnn_load_impl(i5); i5 += 1;
      const xnn_simd_u8_t vi6 = xnn_load_impl(i6); i6 += 1;
      const xnn_simd_u8_t vi7 = xnn_load_impl(i7); i7 += 1;
      const xnn_simd_u8_t vi8 = xnn_load_impl(i8); i8 += 1;
