  ...
  do {
    ...
    for (; n >= 8; n -= 8) {
      ...
      for (; k >= 16; k -= 16) {
        ...
        row7 += 16;
        xnn_prefetch_to_l1((const int8_t*) row0 + 256);
        xnn_prefetch_to_l1((const int8_t*) row1 + 256);
        xnn_prefetch_to_l1((const int8_t*) row2 + 256);
        xnn_prefetch_to_l1((const int8_t*) row3 + 256);
        xnn_prefetch_to_l1((const int8_t*) row4 + 256);
        xnn_prefetch_to_l1((const int8_t*) row5 + 256);
        xnn_prefetch_to_l1((const int8_t*) row6 + 256);
        xnn_prefetch_to_l1((const int8_t*) row7 + 256);
