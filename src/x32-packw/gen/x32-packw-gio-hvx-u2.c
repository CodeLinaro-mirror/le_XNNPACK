  ...
  const void* params)        // unused
{
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        const xnn_simd_s32_t vb0 = xnn_load_tail_nooob_s32(b + 0, vcount0);
        const xnn_simd_s32_t vb1 = xnn_load_tail_nooob_s32(b + 32, vcount1);
        xnn_storeu_s32(packed_w + 0, vb0);
        xnn_storeu_s32(packed_w + 32, vb1);
        b += n;
      } else {
      ...
      for (size_t k = kc; k > 0; --k) {
        const xnn_simd_s32_t v0 = xnn_load_tail_nooob_s32(w + 0, vcount0);
        const xnn_simd_s32_t v1 = xnn_load_tail_nooob_s32(w + 32, vcount1);
        xnn_storeu_s32(packed_w + 0, v0);
        xnn_storeu_s32(packed_w + 32, v1);
        w += k_stride;
        packed_w += 64;
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        const xnn_simd_s32_t vb0 = xnn_load_tail_nooob_s32(b + 0, vcount0);
        const xnn_simd_s32_t vb1 = xnn_load_tail_nooob_s32(b + 32, vcount1);
        const xnn_simd_s32_t vb2 = xnn_load_tail_nooob_s32(b + 64, vcount2);
        xnn_storeu_s32(packed_w + 0, vb0);
        xnn_storeu_s32(packed_w + 32, vb1);
        xnn_storeu_s32(packed_w + 64, vb2);
        b += n;
      ...
      for (size_t k = kc; k > 0; --k) {
        const xnn_simd_s32_t v0 = xnn_load_tail_nooob_s32(w + 0, vcount0);
        const xnn_simd_s32_t v1 = xnn_load_tail_nooob_s32(w + 32, vcount1);
        const xnn_simd_s32_t v2 = xnn_load_tail_nooob_s32(w + 64, vcount2);
        xnn_storeu_s32(packed_w + 0, v0);
        xnn_storeu_s32(packed_w + 32, v1);
        xnn_storeu_s32(packed_w + 64, v2);
        w += k_stride;
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        ...
        const xnn_simd_s32_t vb1 = xnn_load_tail_nooob_s32(b + 32, vcount1);
        const xnn_simd_s32_t vb2 = xnn_load_tail_nooob_s32(b + 64, vcount2);
        const xnn_simd_s32_t vb3 = xnn_load_tail_nooob_s32(b + 96, vcount3);
        xnn_storeu_s32(packed_w + 0, vb0);
        xnn_storeu_s32(packed_w + 32, vb1);
        xnn_storeu_s32(packed_w + 64, vb2);
        xnn_storeu_s32(packed_w + 96, vb3);
      ...
      for (size_t k = kc; k > 0; --k) {
        ...
        const xnn_simd_s32_t v1 = xnn_load_tail_nooob_s32(w + 32, vcount1);
        const xnn_simd_s32_t v2 = xnn_load_tail_nooob_s32(w + 64, vcount2);
        const xnn_simd_s32_t v3 = xnn_load_tail_nooob_s32(w + 96, vcount3);
        xnn_storeu_s32(packed_w + 0, v0);
        xnn_storeu_s32(packed_w + 32, v1);
        xnn_storeu_s32(packed_w + 64, v2);
        xnn_storeu_s32(packed_w + 96, v3);
