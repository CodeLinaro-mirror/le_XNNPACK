...
xnn_load_tail_nooob_s32(const int32_t* input, size_t num_elements) {
...
void xnn_x32_packw_gemm_gio_ukernel_x4__sse41_u2(
  ...
  const void* params)        // unused
{
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        const xnn_simd_s32_t vb0 = xnn_load_tail_nooob_s32(b + 0, vcount0);
        xnn_storeu_s32(packed_w + 0, vb0);
        b += n;
      } else {
        xnn_storeu_s32(packed_w + 0, vzero);
      ...
      for (size_t k = kc; k > 0; --k) {
        const xnn_simd_s32_t v0 = xnn_load_tail_nooob_s32(w + 0, vcount0);
        xnn_storeu_s32(packed_w + 0, v0);
        w += k_stride;
        packed_w += 4;
      }
...
// Pack pre-transposed weights (GIO) for use by f32-gemm
void xnn_x32_packw_gemm_gio_ukernel_x8__sse41_u2(
  size_t g,                  // Batch size (outer loop).  usually 1
  size_t nc,                 // Number of columns and typically large
  size_t kc,                 // Number of rows and typically small
  size_t nr,                 // Matches gemm and is a multiple of vector sizes
  ...
  const void* params)        // unused
{
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        const xnn_simd_s32_t vb0 = xnn_load_tail_nooob_s32(b + 0, vcount0);
        const xnn_simd_s32_t vb1 = xnn_load_tail_nooob_s32(b + 4, vcount1);
        xnn_storeu_s32(packed_w + 0, vb0);
        xnn_storeu_s32(packed_w + 4, vb1);
        b += n;
      } else {
      ...
      for (size_t k = kc; k > 0; --k) {
        const xnn_simd_s32_t v0 = xnn_load_tail_nooob_s32(w + 0, vcount0);
        const xnn_simd_s32_t v1 = xnn_load_tail_nooob_s32(w + 4, vcount1);
        xnn_storeu_s32(packed_w + 0, v0);
        xnn_storeu_s32(packed_w + 4, v1);
        w += k_stride;
        packed_w += 8;
...
// Pack pre-transposed weights (GIO) for use by f32-gemm
void xnn_x32_packw_gemm_gio_ukernel_x12__sse41_u2(
  size_t g,                  // Batch size (outer loop).  usually 1
  size_t nc,                 // Number of columns and typically large
  size_t kc,                 // Number of rows and typically small
  size_t nr,                 // Matches gemm and is a multiple of vector sizes
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        const xnn_simd_s32_t vb0 = xnn_load_tail_nooob_s32(b + 0, vcount0);
        const xnn_simd_s32_t vb1 = xnn_load_tail_nooob_s32(b + 4, vcount1);
        const xnn_simd_s32_t vb2 = xnn_load_tail_nooob_s32(b + 8, vcount2);
        xnn_storeu_s32(packed_w + 0, vb0);
        xnn_storeu_s32(packed_w + 4, vb1);
        xnn_storeu_s32(packed_w + 8, vb2);
        b += n;
      ...
      for (size_t k = kc; k > 0; --k) {
        const xnn_simd_s32_t v0 = xnn_load_tail_nooob_s32(w + 0, vcount0);
        const xnn_simd_s32_t v1 = xnn_load_tail_nooob_s32(w + 4, vcount1);
        const xnn_simd_s32_t v2 = xnn_load_tail_nooob_s32(w + 8, vcount2);
        xnn_storeu_s32(packed_w + 0, v0);
        xnn_storeu_s32(packed_w + 4, v1);
        xnn_storeu_s32(packed_w + 8, v2);
        w += k_stride;
...
// Pack pre-transposed weights (GIO) for use by f32-gemm
void xnn_x32_packw_gemm_gio_ukernel_x16__sse41_u2(
  size_t g,                  // Batch size (outer loop).  usually 1
  size_t nc,                 // Number of columns and typically large
  size_t kc,                 // Number of rows and typically small
  size_t nr,                 // Matches gemm and is a multiple of vector sizes
  ...
  do {
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      if XNN_LIKELY(b != NULL) {
        ...
        const xnn_simd_s32_t vb1 = xnn_load_tail_nooob_s32(b + 4, vcount1);
        const xnn_simd_s32_t vb2 = xnn_load_tail_nooob_s32(b + 8, vcount2);
        const xnn_simd_s32_t vb3 = xnn_load_tail_nooob_s32(b + 12, vcount3);
        xnn_storeu_s32(packed_w + 0, vb0);
        xnn_storeu_s32(packed_w + 4, vb1);
        xnn_storeu_s32(packed_w + 8, vb2);
        xnn_storeu_s32(packed_w + 12, vb3);
      ...
      for (size_t k = kc; k > 0; --k) {
        ...
        const xnn_simd_s32_t v1 = xnn_load_tail_nooob_s32(w + 4, vcount1);
        const xnn_simd_s32_t v2 = xnn_load_tail_nooob_s32(w + 8, vcount2);
        const xnn_simd_s32_t v3 = xnn_load_tail_nooob_s32(w + 12, vcount3);
        xnn_storeu_s32(packed_w + 0, v0);
        xnn_storeu_s32(packed_w + 4, v1);
        xnn_storeu_s32(packed_w + 8, v2);
        xnn_storeu_s32(packed_w + 12, v3);
