  ...
  do {
    ...
    for (; n >= 16; n -= 16) {
      ...
      for (; k >= 4; k -= 4) {
        ...
        // i j k l
        // m n o p
        __m128 vi0x0123 = _mm_loadu_ps(w0);
        w0 += 4;
        __m128 vi1x0123 = _mm_loadu_ps(w1);
        w1 += 4;
        __m128 vi2x0123 = _mm_loadu_ps(w2);
        w2 += 4;
        __m128 vi3x0123 = _mm_loadu_ps(w3);
        w3 += 4;
        __m128 vi4x0123 = _mm_loadu_ps(w4);
        w4 += 4;
        __m128 vi5x0123 = _mm_loadu_ps(w5);
        w5 += 4;
        __m128 vi6x0123 = _mm_loadu_ps(w6);
        w6 += 4;
        __m128 vi7x0123 = _mm_loadu_ps(w7);
        w7 += 4;
        __m128 vi8x0123 = _mm_loadu_ps(w8);
        w8 += 4;
        __m128 vi9x0123 = _mm_loadu_ps(w9);
        w9 += 4;
        __m128 vi10x0123 = _mm_loadu_ps(w10);
        w10 += 4;
        __m128 vi11x0123 = _mm_loadu_ps(w11);
        w11 += 4;
        __m128 vi12x0123 = _mm_loadu_ps(w12);
        w12 += 4;
        __m128 vi13x0123 = _mm_loadu_ps(w13);
        w13 += 4;
        __m128 vi14x0123 = _mm_loadu_ps(w14);
        w14 += 4;
        __m128 vi15x0123 = _mm_loadu_ps(w15);
        w15 += 4;

        __m256 v0x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi0x0123), vi4x0123, 1);
        __m256 v1x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi1x0123), vi5x0123, 1);
        __m256 v2x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi2x0123), vi6x0123, 1);
        __m256 v3x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi3x0123), vi7x0123, 1);
        __m256 v8x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi8x0123), vi12x0123, 1);
        __m256 v9x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi9x0123), vi13x0123, 1);
        __m256 v10x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi10x0123), vi14x0123, 1);
        __m256 v11x0123 = _mm256_insertf128_ps(_mm256_castps128_ps256(vi11x0123), vi15x0123, 1);
    ...
    if XNN_UNLIKELY(n != 0) {
      ...
      for (; k >= 4; k -= 4) {
        ...
        __m128 vi14x0123 = _mm_loadu_ps(w14);
        w14 += 4;
        __m128 vi15x0123 = _mm_setzero_ps();
