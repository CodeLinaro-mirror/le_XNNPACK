...
struct xnn_value_allocation_tracker {
  ...
  // Number of extra values that needs to be tracked but don't exist as actual xnn_value in the runtime. These extra
  // values have the same lifetime as another actual xnn_value. Track using xnn_add_extra_value_allocation_tracker.
...
XNN_INTERNAL void xnn_add_extra_value_allocation_tracker(
