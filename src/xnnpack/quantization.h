...
static inline struct xnn_qd8_qc2w_quantization_params
xnn_qd8_qc2w_asymmetric_quantization_params(float min, float max,
                                            float row_sum) {
  ...
  quantization_params.inv_scale = scale;
  quantization_params.zero_point = nudged_zero_point;
  quantization_params.row_sum = row_sum;
  return quantization_params;
}
...
xnn_f32_qd8_qc2w_asymmetric_quantization_params(
  ...
  struct xnn_qd8_qc2w_quantization_params params =
      xnn_qd8_qc2w_asymmetric_quantization_params(min, max, row_sum);
  *f32_scale = params.inv_scale;
  params.inv_scale = 1.f / params.inv_scale;
  return params;
}
