...
TEST(F32_GAVGPOOL_MINMAX_7P7X__SCALAR_C1, channels_gt_1_multipass_fulltile_with_input_stride) {
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(16)
      .Test(xnn_f32_rdsum_minmax_ukernel_7p7x__sse_c16, xnn_init_f32_scaleminmax_sse_params);
  }

  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_2pass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(16)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(16)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(16)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 8; rows < 14; rows++) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_2pass_subtile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 8; rows < 14; rows++) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 14; rows <= 35; rows += 7) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_eq_16_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 14; rows <= 35; rows += 7) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_div_16_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_div_16_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 32; channels < 128; channels += 16) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_div_16_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 32; channels < 128; channels += 16) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_div_16_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 32; channels < 128; channels += 16) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_lt_16_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_lt_16_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 16; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_lt_16_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 16; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_lt_16_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 16; channels++) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_lt_16_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 16; channels++) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_lt_16_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 16; channels++) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_gt_16_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_gt_16_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 17; channels < 32; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_gt_16_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 17; channels < 32; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_gt_16_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 17; channels < 32; channels++) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_gt_16_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 17; channels < 32; channels++) {
      for (size_t rows = 14; rows < 35; rows += 14) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C16, channels_gt_16_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 17; channels < 32; channels++) {
      for (size_t rows = 14; rows < 35; rows += 14) {
        GAvgPoolMicrokernelTester()
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(32)
      .Test(xnn_f32_rdsum_minmax_ukernel_7p7x__sse_c32, xnn_init_f32_scaleminmax_sse_params);
  }

  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_2pass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(32)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(32)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(32)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 8; rows < 14; rows++) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_2pass_subtile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 8; rows < 14; rows++) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 14; rows <= 35; rows += 7) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_eq_32_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 14; rows <= 35; rows += 7) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_div_32_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_div_32_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 64; channels < 256; channels += 32) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_div_32_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 64; channels < 256; channels += 32) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_div_32_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 64; channels < 256; channels += 32) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_lt_32_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_lt_32_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 32; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_lt_32_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 32; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_lt_32_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 32; channels++) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_lt_32_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 32; channels++) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_lt_32_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 32; channels++) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_gt_32_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_gt_32_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 33; channels < 64; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_gt_32_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 33; channels < 64; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_gt_32_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 33; channels < 64; channels++) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_gt_32_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 33; channels < 64; channels++) {
      for (size_t rows = 14; rows < 35; rows += 14) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C32, channels_gt_32_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 33; channels < 64; channels++) {
      for (size_t rows = 14; rows < 35; rows += 14) {
        GAvgPoolMicrokernelTester()
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(64)
      .Test(xnn_f32_rdsum_minmax_ukernel_7p7x__sse_c64, xnn_init_f32_scaleminmax_sse_params);
  }

  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_2pass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(64)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(64)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    GAvgPoolMicrokernelTester()
      .rows(14)
      .channels(64)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 8; rows < 14; rows++) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_2pass_subtile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 8; rows < 14; rows++) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 14; rows <= 35; rows += 7) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_eq_64_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t rows = 14; rows <= 35; rows += 7) {
      GAvgPoolMicrokernelTester()
        .rows(rows)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_div_64_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_div_64_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 128; channels < 512; channels += 64) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_div_64_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 128; channels < 512; channels += 64) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_div_64_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 128; channels < 512; channels += 64) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_lt_64_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_lt_64_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 64; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_lt_64_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 64; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_lt_64_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 64; channels++) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_lt_64_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 64; channels++) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_lt_64_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 1; channels < 64; channels++) {
      for (size_t rows = 14; rows <= 35; rows += 7) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_gt_64_2pass_fulltile) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_gt_64_2pass_fulltile_with_qmax) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 65; channels < 128; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_gt_64_2pass_fulltile_with_qmin) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 65; channels < 128; channels++) {
      GAvgPoolMicrokernelTester()
        .rows(14)
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_gt_64_2pass_subtile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 65; channels < 128; channels++) {
      for (size_t rows = 8; rows < 14; rows++) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_gt_64_multipass_fulltile) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 65; channels < 128; channels++) {
      for (size_t rows = 14; rows < 35; rows += 14) {
        GAvgPoolMicrokernelTester()
  ...
  TEST(F32_RDSUM_MINMAX_7P7X__SSE_C64, channels_gt_64_multipass_fulltile_with_input_stride) {
    TEST_REQUIRES_X86_SSE;
    for (size_t channels = 65; channels < 128; channels++) {
      for (size_t rows = 14; rows < 35; rows += 14) {
        GAvgPoolMicrokernelTester()
