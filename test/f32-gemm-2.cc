...
#include "gemm-microkernel-tester.h"
  ...
  TEST(F32_GEMM_1X8__WASMRELAXEDSIMD_FMA_SPLAT, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_1x8__wasmrelaxedsimd_fma_splat);
  }
  ...
  TEST(F32_GEMM_1X8S4__WASMRELAXEDSIMD_FMA, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_1x8s4__wasmrelaxedsimd_fma);
  }
  ...
  TEST(F32_GEMM_3X8__WASMRELAXEDSIMD_FMA_SPLAT, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_3x8__wasmrelaxedsimd_fma_splat);
  }
  ...
  TEST(F32_GEMM_4X2C4__WASMRELAXEDSIMD_FMA, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(2)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_4x2c4__wasmrelaxedsimd_fma);
  }
  ...
  TEST(F32_GEMM_4X8__WASMRELAXEDSIMD_FMA_SPLAT, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_4x8__wasmrelaxedsimd_fma_splat);
  }
  ...
  TEST(F32_GEMM_5X8__WASMRELAXEDSIMD_FMA_SPLAT, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_5x8__wasmrelaxedsimd_fma_splat);
  }
  ...
  TEST(F32_GEMM_5X8S4__WASMRELAXEDSIMD_FMA, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_5x8s4__wasmrelaxedsimd_fma);
  }
  ...
  TEST(F32_GEMM_6X8__WASMRELAXEDSIMD_FMA_SPLAT, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_6x8__wasmrelaxedsimd_fma_splat);
  }
  ...
  TEST(F32_GEMM_6X8S4__WASMRELAXEDSIMD_FMA, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_6x8s4__wasmrelaxedsimd_fma);
  }
  ...
  TEST(F32_GEMM_1X8__WASMSIMD_LOADSPLAT, k_eq_1) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(1)
      .Test(xnn_f32_gemm_ukernel_1x8__wasmsimd_loadsplat);
  }
  ...
  TEST(F32_GEMM_1X8S4__WASMSIMD, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_1x8s4__wasmsimd);
  }
  ...
  TEST(F32_GEMM_6X8__WASMSIMD_LOADSPLAT, k_eq_1) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(1)
      .Test(xnn_f32_gemm_ukernel_6x8__wasmsimd_loadsplat);
  }
  ...
  TEST(F32_GEMM_6X8S4__WASMSIMD, k_eq_4) {
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(4)
      .Test(xnn_f32_gemm_ukernel_6x8s4__wasmsimd);
  }
