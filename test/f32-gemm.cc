...
#include "gemm-microkernel-tester.h"
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_eq_2) {
    GemmMicrokernelTester()
      .mr(4)
      .nr(4)
      .kr(1)
      ...
      .n(4)
      .k(2)
      .Test(xnn_f32_gemm_ukernel_4x4__asm_aarch32_vfp_ld64);
  }

  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, strided_cn) {
    GemmMicrokernelTester()
      .mr(4)
      .nr(4)
      .kr(1)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_eq_2_strided_a) {
    GemmMicrokernelTester()
      .mr(4)
      .nr(4)
      .kr(1)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_eq_2_subtile) {
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_eq_2_subtile_m) {
    for (uint32_t m = 1; m <= 4; m++) {
      GemmMicrokernelTester()
        .mr(4)
        .nr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_eq_2_subtile_n) {
    for (uint32_t n = 1; n <= 4; n++) {
      GemmMicrokernelTester()
        .mr(4)
        .nr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_lt_2) {
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_lt_2_strided_a) {
    for (size_t k = 1; k < 2; k++) {
      GemmMicrokernelTester()
        .mr(4)
        .nr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_lt_2_subtile) {
    for (size_t k = 1; k < 2; k++) {
      for (uint32_t n = 1; n <= 4; n++) {
        for (uint32_t m = 1; m <= 4; m++) {
          GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_gt_2) {
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_gt_2_strided_a) {
    for (size_t k = 3; k < 4; k++) {
      GemmMicrokernelTester()
        .mr(4)
        .nr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_gt_2_subtile) {
    for (size_t k = 3; k < 4; k++) {
      for (uint32_t n = 1; n <= 4; n++) {
        for (uint32_t m = 1; m <= 4; m++) {
          GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_div_2) {
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_div_2_strided_a) {
    for (size_t k = 4; k <= 20; k += 2) {
      GemmMicrokernelTester()
        .mr(4)
        .nr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, k_div_2_subtile) {
    for (size_t k = 4; k <= 20; k += 2) {
      for (uint32_t n = 1; n <= 4; n++) {
        for (uint32_t m = 1; m <= 4; m++) {
          GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_gt_4) {
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_gt_4_strided_cn) {
    for (uint32_t n = 5; n < 8; n++) {
      for (size_t k = 1; k <= 10; k += 3) {
        GemmMicrokernelTester()
          .mr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_gt_4_strided_a) {
    for (uint32_t n = 5; n < 8; n++) {
      for (size_t k = 1; k <= 10; k += 3) {
        GemmMicrokernelTester()
          .mr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_gt_4_subtile) {
    for (uint32_t n = 5; n < 8; n++) {
      for (size_t k = 1; k <= 10; k += 3) {
        for (uint32_t m = 1; m <= 4; m++) {
          GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_div_4) {
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_div_4_strided_cn) {
    for (uint32_t n = 8; n <= 12; n += 4) {
      for (size_t k = 1; k <= 10; k += 3) {
        GemmMicrokernelTester()
          .mr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_div_4_strided_a) {
    for (uint32_t n = 8; n <= 12; n += 4) {
      for (size_t k = 1; k <= 10; k += 3) {
        GemmMicrokernelTester()
          .mr(4)
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, n_div_4_subtile) {
    for (uint32_t n = 8; n <= 12; n += 4) {
      for (size_t k = 1; k <= 10; k += 3) {
        for (uint32_t m = 1; m <= 4; m++) {
          GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, strided_cm_subtile) {
    for (size_t k = 1; k <= 10; k += 3) {
      for (uint32_t n = 1; n <= 4; n++) {
        for (uint32_t m = 1; m <= 4; m++) {
          GemmMicrokernelTester()
  ...
  TEST(F32_GEMM_4X4__ASM_AARCH32_VFP_LD64, strided_cm) {
    GemmMicrokernelTester()
      .mr(4)
      .nr(4)
      .kr(1)
