...
#include "vunary-microkernel-tester.h"
  ...
  TEST(F32_VABS__NEON_U4, batch_eq_4) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vabs_ukernel__neon_u4);
  }
  ...
  TEST(F32_VABS__NEON_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vabs_ukernel__neon_u8);
  }
  ...
  TEST(F32_VABS__NEON_U12, batch_eq_12) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(12)
      .Test(xnn_f32_vabs_ukernel__neon_u12);
  }
  ...
  TEST(F32_VABS__RVV_U2V, batch_eq_2v) {
    ...
    VUnaryMicrokernelTester()
      ...
      .Test(xnn_f32_vabs_ukernel__rvv_u2v);
  }
  ...
  TEST(F32_VABS__RVV_U4V, batch_eq_4v) {
    ...
    VUnaryMicrokernelTester()
      ...
      .Test(xnn_f32_vabs_ukernel__rvv_u4v);
  }
  ...
  TEST(F32_VABS__RVV_U8V, batch_eq_8v) {
    ...
    VUnaryMicrokernelTester()
      ...
      .Test(xnn_f32_vabs_ukernel__rvv_u8v);
  }
  ...
  TEST(F32_VABS__SSE2_U4, batch_eq_4) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vabs_ukernel__sse2_u4, xnn_init_f32_abs_sse2_params);
  }
  ...
  TEST(F32_VABS__SSE2_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vabs_ukernel__sse2_u8, xnn_init_f32_abs_sse2_params);
  }
  ...
  TEST(F32_VABS__SSE2_U12, batch_eq_12) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(12)
      .Test(xnn_f32_vabs_ukernel__sse2_u12, xnn_init_f32_abs_sse2_params);
  }
  ...
  TEST(F32_VABS__AVX_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vabs_ukernel__avx_u8, xnn_init_f32_abs_avx_params);
  }
  ...
  TEST(F32_VABS__AVX_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vabs_ukernel__avx_u16, xnn_init_f32_abs_avx_params);
  }
  ...
  TEST(F32_VABS__AVX_U24, batch_eq_24) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vabs_ukernel__avx_u24, xnn_init_f32_abs_avx_params);
  }
  ...
  TEST(F32_VABS__AVX512F_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vabs_ukernel__avx512f_u16, xnn_init_f32_abs_avx512f_params);
  }
  ...
  TEST(F32_VABS__AVX512F_U32, batch_eq_32) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vabs_ukernel__avx512f_u32, xnn_init_f32_abs_avx512f_params);
  }
  ...
  TEST(F32_VABS__AVX512F_U48, batch_eq_48) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f32_vabs_ukernel__avx512f_u48, xnn_init_f32_abs_avx512f_params);
  }
  ...
  TEST(F32_VABS__WASMSIMD_U4, batch_eq_4) {
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vabs_ukernel__wasmsimd_u4, xnn_init_f32_abs_wasmsimd_params);
  }
  ...
  TEST(F32_VABS__WASMSIMD_U8, batch_eq_8) {
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vabs_ukernel__wasmsimd_u8, xnn_init_f32_abs_wasmsimd_params);
  }
  ...
  TEST(F32_VABS__WASMSIMD_U12, batch_eq_12) {
    VUnaryMicrokernelTester()
      .batch_size(12)
      .Test(xnn_f32_vabs_ukernel__wasmsimd_u12, xnn_init_f32_abs_wasmsimd_params);
  }
...
TEST(F32_VABS__SCALAR_U1, batch_eq_1) {
  VUnaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_f32_vabs_ukernel__scalar_u1);
}
...
TEST(F32_VABS__SCALAR_U2, batch_eq_2) {
  VUnaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_f32_vabs_ukernel__scalar_u2);
}
...
TEST(F32_VABS__SCALAR_U4, batch_eq_4) {
  VUnaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_f32_vabs_ukernel__scalar_u4);
}
