...
#include "vunary-microkernel-tester.h"
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U16, batch_eq_16) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u16, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U16, batch_div_16) {
    TEST_REQUIRES_X86_SSE;
    for (size_t batch_size = 32; batch_size < 160; batch_size += 16) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U16, batch_lt_16) {
    TEST_REQUIRES_X86_SSE;
    for (size_t batch_size = 1; batch_size < 16; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U16, batch_gt_16) {
    TEST_REQUIRES_X86_SSE;
    for (size_t batch_size = 16 + 1; batch_size < 32; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U16, inplace) {
    TEST_REQUIRES_X86_SSE;
    for (size_t batch_size = 1; batch_size <= 80; batch_size += 15) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U20, batch_eq_20) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(20)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u20, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U20, batch_div_20) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U20, batch_lt_20) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U20, batch_gt_20) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U20, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U24, batch_eq_24) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u24, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U24, batch_div_24) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U24, batch_lt_24) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U24, batch_gt_24) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U24, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U28, batch_eq_28) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(28)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u28, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U28, batch_div_28) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U28, batch_lt_28) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U28, batch_gt_28) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U28, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__SSE_RSQRT_U32, batch_eq_32) {
    TEST_REQUIRES_X86_SSE;
    VUnaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vsqrt_ukernel__sse_rsqrt_u32, xnn_init_f32_sqrt_sse_params);
  }

  TEST(F32_VSQRT__SSE_RSQRT_U32, batch_div_32) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U32, batch_lt_32) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U32, batch_gt_32) {
    TEST_REQUIRES_X86_SSE;
  ...
  TEST(F32_VSQRT__SSE_RSQRT_U32, inplace) {
    TEST_REQUIRES_X86_SSE;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX_RSQRT_U24, batch_eq_24) {
    TEST_REQUIRES_X86_AVX;
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vsqrt_ukernel__avx_rsqrt_u24, xnn_init_f32_sqrt_avx_params);
  }

  TEST(F32_VSQRT__AVX_RSQRT_U24, batch_div_24) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 48; batch_size < 240; batch_size += 24) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U24, batch_lt_24) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size < 24; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U24, batch_gt_24) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 24 + 1; batch_size < 48; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U24, inplace) {
    TEST_REQUIRES_X86_AVX;
    for (size_t batch_size = 1; batch_size <= 120; batch_size += 23) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX_RSQRT_U40, batch_eq_40) {
    TEST_REQUIRES_X86_AVX;
    VUnaryMicrokernelTester()
      .batch_size(40)
      .Test(xnn_f32_vsqrt_ukernel__avx_rsqrt_u40, xnn_init_f32_sqrt_avx_params);
  }

  TEST(F32_VSQRT__AVX_RSQRT_U40, batch_div_40) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U40, batch_lt_40) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U40, batch_gt_40) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U40, inplace) {
    TEST_REQUIRES_X86_AVX;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX_RSQRT_U48, batch_eq_48) {
    TEST_REQUIRES_X86_AVX;
    VUnaryMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f32_vsqrt_ukernel__avx_rsqrt_u48, xnn_init_f32_sqrt_avx_params);
  }

  TEST(F32_VSQRT__AVX_RSQRT_U48, batch_div_48) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U48, batch_lt_48) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U48, batch_gt_48) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U48, inplace) {
    TEST_REQUIRES_X86_AVX;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX_RSQRT_U56, batch_eq_56) {
    TEST_REQUIRES_X86_AVX;
    VUnaryMicrokernelTester()
      .batch_size(56)
      .Test(xnn_f32_vsqrt_ukernel__avx_rsqrt_u56, xnn_init_f32_sqrt_avx_params);
  }

  TEST(F32_VSQRT__AVX_RSQRT_U56, batch_div_56) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U56, batch_lt_56) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U56, batch_gt_56) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U56, inplace) {
    TEST_REQUIRES_X86_AVX;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX_RSQRT_U64, batch_eq_64) {
    TEST_REQUIRES_X86_AVX;
    VUnaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_vsqrt_ukernel__avx_rsqrt_u64, xnn_init_f32_sqrt_avx_params);
  }

  TEST(F32_VSQRT__AVX_RSQRT_U64, batch_div_64) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U64, batch_lt_64) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U64, batch_gt_64) {
    TEST_REQUIRES_X86_AVX;
  ...
  TEST(F32_VSQRT__AVX_RSQRT_U64, inplace) {
    TEST_REQUIRES_X86_AVX;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__FMA3_RSQRT_U24, batch_eq_24) {
    TEST_REQUIRES_X86_FMA3;
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vsqrt_ukernel__fma3_rsqrt_u24, xnn_init_f32_sqrt_fma_params);
  }

  TEST(F32_VSQRT__FMA3_RSQRT_U24, batch_div_24) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 48; batch_size < 240; batch_size += 24) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U24, batch_lt_24) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size < 24; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U24, batch_gt_24) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 24 + 1; batch_size < 48; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U24, inplace) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size <= 120; batch_size += 23) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__FMA3_RSQRT_U40, batch_eq_40) {
    TEST_REQUIRES_X86_FMA3;
    VUnaryMicrokernelTester()
      .batch_size(40)
      .Test(xnn_f32_vsqrt_ukernel__fma3_rsqrt_u40, xnn_init_f32_sqrt_fma_params);
  }

  TEST(F32_VSQRT__FMA3_RSQRT_U40, batch_div_40) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 80; batch_size < 400; batch_size += 40) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U40, batch_lt_40) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size < 40; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U40, batch_gt_40) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 40 + 1; batch_size < 80; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U40, inplace) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size <= 200; batch_size += 39) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__FMA3_RSQRT_U48, batch_eq_48) {
    TEST_REQUIRES_X86_FMA3;
    VUnaryMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f32_vsqrt_ukernel__fma3_rsqrt_u48, xnn_init_f32_sqrt_fma_params);
  }

  TEST(F32_VSQRT__FMA3_RSQRT_U48, batch_div_48) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 96; batch_size < 480; batch_size += 48) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U48, batch_lt_48) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size < 48; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U48, batch_gt_48) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 48 + 1; batch_size < 96; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U48, inplace) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size <= 240; batch_size += 47) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__FMA3_RSQRT_U56, batch_eq_56) {
    TEST_REQUIRES_X86_FMA3;
    VUnaryMicrokernelTester()
      .batch_size(56)
      .Test(xnn_f32_vsqrt_ukernel__fma3_rsqrt_u56, xnn_init_f32_sqrt_fma_params);
  }

  TEST(F32_VSQRT__FMA3_RSQRT_U56, batch_div_56) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 112; batch_size < 560; batch_size += 56) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U56, batch_lt_56) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size < 56; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U56, batch_gt_56) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 56 + 1; batch_size < 112; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U56, inplace) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size <= 280; batch_size += 55) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__FMA3_RSQRT_U64, batch_eq_64) {
    TEST_REQUIRES_X86_FMA3;
    VUnaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_vsqrt_ukernel__fma3_rsqrt_u64, xnn_init_f32_sqrt_fma_params);
  }

  TEST(F32_VSQRT__FMA3_RSQRT_U64, batch_div_64) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U64, batch_lt_64) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U64, batch_gt_64) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 64 + 1; batch_size < 128; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__FMA3_RSQRT_U64, inplace) {
    TEST_REQUIRES_X86_FMA3;
    for (size_t batch_size = 1; batch_size <= 320; batch_size += 63) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX512F_RSQRT_U64, batch_eq_64) {
    TEST_REQUIRES_X86_AVX512F;
    VUnaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u64, xnn_init_f32_sqrt_avx512_params);
  }

  TEST(F32_VSQRT__AVX512F_RSQRT_U64, batch_div_64) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 128; batch_size < 640; batch_size += 64) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U64, batch_lt_64) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size < 64; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U64, batch_gt_64) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 64 + 1; batch_size < 128; batch_size++) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U64, inplace) {
    TEST_REQUIRES_X86_AVX512F;
    for (size_t batch_size = 1; batch_size <= 320; batch_size += 63) {
      VUnaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX512F_RSQRT_U80, batch_eq_80) {
    TEST_REQUIRES_X86_AVX512F;
    VUnaryMicrokernelTester()
      .batch_size(80)
      .Test(xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u80, xnn_init_f32_sqrt_avx512_params);
  }

  TEST(F32_VSQRT__AVX512F_RSQRT_U80, batch_div_80) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U80, batch_lt_80) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U80, batch_gt_80) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U80, inplace) {
    TEST_REQUIRES_X86_AVX512F;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX512F_RSQRT_U96, batch_eq_96) {
    TEST_REQUIRES_X86_AVX512F;
    VUnaryMicrokernelTester()
      .batch_size(96)
      .Test(xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u96, xnn_init_f32_sqrt_avx512_params);
  }

  TEST(F32_VSQRT__AVX512F_RSQRT_U96, batch_div_96) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U96, batch_lt_96) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U96, batch_gt_96) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U96, inplace) {
    TEST_REQUIRES_X86_AVX512F;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX512F_RSQRT_U112, batch_eq_112) {
    TEST_REQUIRES_X86_AVX512F;
    VUnaryMicrokernelTester()
      .batch_size(112)
      .Test(xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u112, xnn_init_f32_sqrt_avx512_params);
  }

  TEST(F32_VSQRT__AVX512F_RSQRT_U112, batch_div_112) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U112, batch_lt_112) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U112, batch_gt_112) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U112, inplace) {
    TEST_REQUIRES_X86_AVX512F;
...
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
  TEST(F32_VSQRT__AVX512F_RSQRT_U128, batch_eq_128) {
    TEST_REQUIRES_X86_AVX512F;
    VUnaryMicrokernelTester()
      .batch_size(128)
      .Test(xnn_f32_vsqrt_ukernel__avx512f_rsqrt_u128, xnn_init_f32_sqrt_avx512_params);
  }

  TEST(F32_VSQRT__AVX512F_RSQRT_U128, batch_div_128) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U128, batch_lt_128) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U128, batch_gt_128) {
    TEST_REQUIRES_X86_AVX512F;
  ...
  TEST(F32_VSQRT__AVX512F_RSQRT_U128, inplace) {
    TEST_REQUIRES_X86_AVX512F;
