...
TEST(FULLY_CONNECTED_NC_QD8_F32_QC4W, unit_batch_with_kernel_zero_point) {
  FullyConnectedOperatorTester()
    .batch_size(1)
    .input_channels(23)
    .output_channels(19)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QC4W, small_batch_with_kernel_zero_point) {
  FullyConnectedOperatorTester()
    .batch_size(12)
    .input_channels(23)
    .output_channels(19)
...
TEST(FULLY_CONNECTED_NC_QD8_QC8W_F32, unit_batch) {
  FullyConnectedOperatorTester()
    .batch_size(1)
    .input_channels(8)
    .output_channels(4)
...
TEST(FULLY_CONNECTED_NC_QD8_QC8W_F32, unit_batch_transpose_weights) {
  FullyConnectedOperatorTester()
    .transpose_weights(true)
    .batch_size(1)
    .input_channels(23)
...
TEST(FULLY_CONNECTED_NC_QD8_QC8W_F32, unit_batch_without_bias) {
  FullyConnectedOperatorTester()
    .has_bias(false)
    .batch_size(1)
    .input_channels(23)
...
TEST(FULLY_CONNECTED_NC_QD8_QC8W_F32, small_batch) {
  FullyConnectedOperatorTester()
    .batch_size(4)
    .input_channels(1)
    .output_channels(16)
...
TEST(FULLY_CONNECTED_NC_QD8_QC8W_F32, small_batch_without_bias) {
  FullyConnectedOperatorTester()
    .has_bias(false)
    .batch_size(12)
    .input_channels(23)
...
TEST(FULLY_CONNECTED_NC_QD8_QC8W_F32, weights_cache_unit_batch_transpose_weights) {
  FullyConnectedOperatorTester()
    .transpose_weights(true)
    .batch_size(1)
    .input_channels(23)
