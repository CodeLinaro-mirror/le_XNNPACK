...
TEST(PACK_QD8_F32_QC4W_GEMM_GIO_W, g_eq_1) {
  ...
  const std::vector<uint8_t> expected = {
    ...
    0x30 ^ 0x88, 0x96 ^ 0x88,
    0x41 ^ 0x88, 0xa7 ^ 0x88,
    0x8c ^ 0x88, 0x88 ^ 0x88,  // kernel zero point (0x8)
    0x8d ^ 0x88, 0x88 ^ 0x88,  // kernel zero point (0x8)
    // 1 bias and padding.
    0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
    0x52 ^ 0x88, 0xb8 ^ 0x88,
    0x88 ^ 0x88, 0x88 ^ 0x88,
    0x8e ^ 0x88, 0x88 ^ 0x88,  // kernel zero point (0x8)
    0x88 ^ 0x88, 0x88 ^ 0x88,
  };
...
TEST(PACK_QD8_F32_QC4W_GEMM_GOI_W, g_eq_1) {
  ...
  const std::vector<uint8_t> expected = {
    ...
    0x10 ^ 0x88, 0x32 ^ 0x88,
    0x65 ^ 0x88, 0x87 ^ 0x88,
    0x84 ^ 0x88, 0x88 ^ 0x88,  // kernel zero point (0x8)
    0x89 ^ 0x88, 0x88 ^ 0x88,
    // 1 bias and padding.
    0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
