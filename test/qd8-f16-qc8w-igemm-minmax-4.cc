...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC8W_IGEMM_MINMAX_8X8C8__AVX256VNNI, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          /*mr=*/8, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc8w_igemm_minmax_ukernel_8x8c8__avx256vnni,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_pack_qs8_conv_goki_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F16_QC8W_IGEMM_MINMAX_10X8C8__AVX256VNNI, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          ...
          /*unsigned_inputs=*/true,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f16_qc8w_igemm_minmax_ukernel_10x8c8__avx256vnni,
                        xnn_init_f16_minmax_scalar_params,
                        xnn_pack_qs8_conv_goki_w);
          },
          []() {
