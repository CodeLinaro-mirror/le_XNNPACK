...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC4W_GEMM_MINMAX_12X8C8__AVX512VNNI, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          ...
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc4w_gemm_minmax_ukernel_12x8c8__avx512vnni,
                        xnn_init_f32_qc4w_minmax_avxvnni_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC4W_GEMM_MINMAX_14X8C8__AVX512VNNI, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          ...
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc4w_gemm_minmax_ukernel_14x8c8__avx512vnni,
                        xnn_init_f32_qc4w_minmax_avxvnni_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC4W_GEMM_MINMAX_10X8C8__AVX512VNNIGFNI, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          ...
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc4w_gemm_minmax_ukernel_10x8c8__avx512vnnigfni,
                        xnn_init_f32_qc4w_minmax_avxvnni_params,
                        xnn_pack_qs8_qc4w_gemm_goi_w);
          },
          []() {
