...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC8W_GEMM_MINMAX_1X8C8__WASMSDOT_U2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/1, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*unsigned_inputs=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc8w_gemm_minmax_ukernel_1x8c8__wasmsdot_u2,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_qs8_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC8W_GEMM_MINMAX_2X8C8__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/2, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*unsigned_inputs=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc8w_gemm_minmax_ukernel_2x8c8__wasmsdot,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_qs8_gemm_goi_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      QD8_F32_QC8W_GEMM_MINMAX_3X8C8__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/3, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*unsigned_inputs=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qd8_f32_qc8w_gemm_minmax_ukernel_3x8c8__wasmsdot,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_qs8_gemm_goi_w);
          },
          []() {
