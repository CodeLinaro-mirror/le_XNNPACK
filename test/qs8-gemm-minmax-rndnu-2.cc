...
#include "gemm-microkernel-tester.h"
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_eq_8) {
    ...
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(8)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_8x8c8__neoni8mm, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_qs8_requantize_rndnu);
  }
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_eq_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    GemmMicrokernelTester()
      .mr(8)
      .nr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_eq_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_eq_8_subtile_m) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t m = 1; m <= 8; m++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_eq_8_subtile_n) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (uint32_t n = 1; n <= 8; n++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_lt_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_lt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_lt_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 1; k < 8; k++) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_gt_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_div_8) {
    TEST_REQUIRES_ARM_NEON_I8MM;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 16; k <= 80; k += 8) {
      GemmMicrokernelTester()
        .mr(8)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_8X8C8__NEONI8MM, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON_I8MM;
    for (size_t k = 16; k <= 80; k += 8) {
      for (uint32_t n = 1; n <= 8; n++) {
        for (uint32_t m = 1; m <= 8; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_eq_16) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
      ...
      .n(16)
      .k(16)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_1x16c8__aarch64_neondot_ld128, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_qs8_requantize_rndnu);
  }

  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, strided_cn) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_eq_16_strided_a) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_eq_16_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 1; n <= 16; n++) {
      for (uint32_t m = 1; m <= 1; m++) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_eq_16_subtile_m) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t m = 1; m <= 1; m++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_eq_16_subtile_n) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 1; n <= 16; n++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_lt_16) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_lt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_lt_16_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k < 16; k++) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_gt_16) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_gt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 17; k < 32; k++) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_gt_16_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 17; k < 32; k++) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_div_16) {
    TEST_REQUIRES_ARM_NEON_DOT;
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_div_16_strided_a) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 32; k <= 160; k += 16) {
      GemmMicrokernelTester()
        .mr(1)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, k_div_16_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 32; k <= 160; k += 16) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_gt_16) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 17; n < 32; n++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_gt_16_strided_cn) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 17; n < 32; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_gt_16_strided_a) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 17; n < 32; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_gt_16_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 17; n < 32; n++) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_div_16) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 32; n <= 48; n += 16) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_div_16_strided_cn) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 32; n <= 48; n += 16) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_div_16_strided_a) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 32; n <= 48; n += 16) {
      for (size_t k = 1; k <= 80; k += 17) {
        GemmMicrokernelTester()
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, n_div_16_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (uint32_t n = 32; n <= 48; n += 16) {
      for (size_t k = 1; k <= 80; k += 17) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, strided_cm_subtile) {
    TEST_REQUIRES_ARM_NEON_DOT;
    for (size_t k = 1; k <= 80; k += 17) {
      for (uint32_t n = 1; n <= 16; n++) {
        for (uint32_t m = 1; m <= 1; m++) {
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, qmin) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, qmax) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_1X16C8__AARCH64_NEONDOT_LD128, strided_cm) {
    TEST_REQUIRES_ARM_NEON_DOT;
    GemmMicrokernelTester()
      .mr(1)
      .nr(16)
  ...
  TEST(QS8_GEMM_MINMAX_RNDNU_4X8__ASM_AARCH32_NEON_MLAL_LANE_CORTEX_A53_PRFM, k_eq_8) {
    ...
    GemmMicrokernelTester()
      ...
      .n(8)
      .k(8)
      .Test(xnn_qs8_gemm_minmax_rndnu_ukernel_4x8__asm_aarch32_neon_mlal_lane_cortex_a53_prfm, xnn_init_qs8_conv_minmax_rndnu_neon_params, xnn_qs8_requantize_rndnu);
  }
