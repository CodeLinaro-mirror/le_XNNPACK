...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_1X16C2S2__WASMSIMD_DOT16X2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x16c2s2__wasmsimd_dot16x2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          })),
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_4X16C2S2__WASMSIMD_DOT16X2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c2s2__wasmsimd_dot16x2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          })),
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_1X8C8__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/1, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x8c8__wasmsdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_1X8C8__WASMSDOT_U2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/1, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x8c8__wasmsdot_u2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_2X8C8__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/2, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_2x8c8__wasmsdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_4X8C8__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/4, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x8c8__wasmsdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_1X16C4__WASMUSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/1, /*nr=*/16, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x16c4__wasmusdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_to_qu8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_1X16C4__WASMUSDOT_U2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/1, /*nr=*/16, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x16c4__wasmusdot_u2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_to_qu8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_4X16C4__WASMUSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/4, /*nr=*/16, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c4__wasmusdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_to_qu8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_4X16C4__WASMUSDOT_U2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/4, /*nr=*/16, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c4__wasmusdot_u2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_to_qu8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_1X16C4__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/1, /*nr=*/16, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_1x16c4__wasmsdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_3X16C4__WASMSDOT, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_3x16c4__wasmsdot,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_4X16C4__WASMSDOT_U2_ACC2, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/4, /*nr=*/16, /*kr=*/4, /*sr=*/1,
          ...
          /*planes=*/1,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_4x16c4__wasmsdot_u2_acc2,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_scalar_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
