...
std::vector<GemmTestParams> CreateTests1(
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_5X8C8__AVX256SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/5, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_5x8c8__avx256skx,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_avx2_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_8X8C8__AVX256SKX, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/8,
          /*adj_k_block=*/8,
          /*mr=*/8, /*nr=*/8, /*kr=*/8, /*sr=*/1,
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_8x8c8__avx256skx,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_avx2_params,
                        xnn_pack_qs8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_14X8C8__AVX512VNNI, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          ...
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_14x8c8__avx512vnni,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_avxvnni_params,
                        xnn_pack_qs8_to_qu8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
  ...
  INSTANTIATE_TEST_SUITE_P(
      QS8_QC8W_IGEMM_MINMAX_FP32_12X8C8__AVX512VNNI_PRFM, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/16,
          /*adj_k_block=*/16,
          ...
          /*is_igemm=*/false,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_12x8c8__avx512vnni_prfm,
                        xnn_init_qs8_qc8w_conv_minmax_fp32_avxvnni_params,
                        xnn_pack_qs8_to_qu8_conv_goki_w,
                        xnn_qs8_requantize_fp32);
          },
