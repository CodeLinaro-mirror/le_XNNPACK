...
TEST(QS8_RSUM__SCALAR_U4, overflow_accumulator) {
...
#if XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  TEST(QS8_RSUM__WASMSIMD_U24_ACC3, batch_eq_24) {
    RSumMicrokernelTester()
      .batch_size(24)
      .Test(xnn_qs8_rsum_ukernel__wasmsimd_u24_acc3);
  }

  TEST(QS8_RSUM__WASMSIMD_U24_ACC3, batch_div_24) {
  ...
  TEST(QS8_RSUM__WASMSIMD_U24_ACC3, batch_lt_24) {
  ...
  TEST(QS8_RSUM__WASMSIMD_U24_ACC3, batch_gt_24) {
  ...
  TEST(QS8_RSUM__WASMSIMD_U24_ACC3, scale) {
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(25)
        .scale(scale)
  ...
  TEST(QS8_RSUM__WASMSIMD_U24_ACC3, overflow_accumulator) {
    RSumMicrokernelTester()
      .batch_size(3072)
      .Test(xnn_qs8_rsum_ukernel__wasmsimd_u24_acc3);
  }
