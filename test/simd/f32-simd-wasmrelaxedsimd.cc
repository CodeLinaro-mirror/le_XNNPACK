...
class F32SimdWASMRELAXEDSIMDTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Mul) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Fmadd) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Fmsub) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
  const xnn_simd_f32_t c =
      xnn_loadu_f32(inputs_.data() + 2 * xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Fnmadd) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
  const xnn_simd_f32_t c =
      xnn_loadu_f32(inputs_.data() + 2 * xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Sub) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Div) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Max) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Min) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Abs) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Neg) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Round) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, ReduceAdd) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, And) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Or) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Xor) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  const xnn_simd_f32_t b = xnn_loadu_f32(inputs_.data() + xnn_simd_size_f32);
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, ShiftLeft) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, ShiftRight) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  // Not using a loop since the `bits` parameter needs to be a compile-time
  // constant, e.g. for `neon`.
  {
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, ShiftRightSigned) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
  // Not using a loop since the `bits` parameter needs to be a compile-time
  // constant, e.g. for `neon`.
  {
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, CmpEq) {
  for (size_t k = 0; k < xnn_simd_size_f32; k++) {
    if (rng_() & 1) {
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, Reduce_Add) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
...
TEST_F(F32SimdWASMRELAXEDSIMDTest, StoreTail) {
  const xnn_simd_f32_t a = xnn_loadu_f32(inputs_.data());
