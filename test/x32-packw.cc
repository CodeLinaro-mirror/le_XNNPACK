...
TEST(X32_PACKW_GEMM_GOI_X4__SCALAR_FLOAT, null_bias) {
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, n_eq_2) {
    ...
    PackWMicrokernelTester()
      ...
      .kr(1)
      .sr(1)
      .Test(xnn_x32_packw_gemm_goi_ukernel_x2__neon_vld2_lane);
  }

  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, g_eq_2) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .g(2)
      .n(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, n_div_2) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(4)
      .k(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, n_lt_2) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 1; n < 2; n++) {
      PackWMicrokernelTester()
        .n(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, n_gt_2) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 3; n < 4; n++) {
      PackWMicrokernelTester()
        .n(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, k_eq_2) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .k(2)
      .n(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, k_div_2) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 4; n < 20; n += 2) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, k_lt_2) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 1; n < 2; n++) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, k_gt_2) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 3; n < 4; n++) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2__NEON_VLD2_LANE, null_bias) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 1; n < 4; n++) {
      PackWMicrokernelTester()
        .n(n)
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, n_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(8)
      .k(8)
      ...
      .kr(1)
      .sr(1)
      .Test(xnn_x32_packw_gemm_goi_ukernel_x8__neon_vld4_lane);
  }

  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, g_eq_2) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .g(2)
      .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, n_div_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(16)
      .k(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, n_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 1; n < 8; n++) {
      PackWMicrokernelTester()
        .n(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, n_gt_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .k(8)
      .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, k_lt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 1; n < 8; n++) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 9; n < 16; n++) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__NEON_VLD4_LANE, null_bias) {
    TEST_REQUIRES_ARM_NEON;
...
#if XNN_ARCH_ARM || XNN_ARCH_ARM64
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, n_eq_12) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(12)
      .k(12)
      ...
      .kr(1)
      .sr(1)
      .Test(xnn_x32_packw_gemm_goi_ukernel_x12__neon_vld4_lane);
  }

  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, g_eq_2) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .g(2)
      .n(12)
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, n_div_12) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .n(24)
      .k(12)
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, n_lt_12) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, n_gt_12) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, k_eq_12) {
    TEST_REQUIRES_ARM_NEON;
    PackWMicrokernelTester()
      .k(12)
      .n(12)
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, k_div_12) {
    TEST_REQUIRES_ARM_NEON;
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, k_lt_12) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 1; n < 12; n++) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, k_gt_12) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t n = 13; n < 24; n++) {
      PackWMicrokernelTester()
        .k(n)
  ...
  TEST(X32_PACKW_GEMM_GOI_X12__NEON_VLD4_LANE, null_bias) {
    TEST_REQUIRES_ARM_NEON;
