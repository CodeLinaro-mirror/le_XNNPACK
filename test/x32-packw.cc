...
TEST(X32_PACKW_GEMM_GOI_X8__SCALAR_INT_X4, null_bias) {
  ...
  TEST(X32_PACKW_GEMM_GOI_X2C4__SSE2_X1, k_eq_2) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .n(2)
      .k(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2C4__SSE2_X1, k_div_2) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .n(2)
      .k(10)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2C4__SSE2_X1, k_lt_2) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 2; k++) {
      PackWMicrokernelTester()
        .n(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2C4__SSE2_X1, k_gt_2) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 3; k < 4; k++) {
      PackWMicrokernelTester()
        .n(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X2C4__SSE2_X1, g_eq_2) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .g(2)
      .n(2)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__SSE2_X4, k_eq_8) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .n(8)
      .k(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__SSE2_X4, k_div_8) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .n(8)
      .k(40)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__SSE2_X4, k_lt_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__SSE2_X4, k_gt_8) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 9; k < 16; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8S4__SSE2_X4, g_eq_2) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .g(2)
      .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__SSE2_X4, k_eq_16) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .n(16)
      .k(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__SSE2_X4, k_div_16) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .n(16)
      .k(80)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__SSE2_X4, k_lt_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 1; k < 16; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__SSE2_X4, k_gt_16) {
    TEST_REQUIRES_X86_SSE2;
    for (size_t k = 17; k < 32; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16S4__SSE2_X4, g_eq_2) {
    TEST_REQUIRES_X86_SSE2;
    PackWMicrokernelTester()
      .g(2)
      .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__AVX_X4, k_eq_8) {
    TEST_REQUIRES_X86_AVX;
    PackWMicrokernelTester()
      .n(8)
      .k(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__AVX_X4, k_div_8) {
    TEST_REQUIRES_X86_AVX;
    PackWMicrokernelTester()
      .n(8)
      .k(40)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__AVX_X4, k_lt_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t k = 1; k < 8; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__AVX_X4, k_gt_8) {
    TEST_REQUIRES_X86_AVX;
    for (size_t k = 9; k < 16; k++) {
      PackWMicrokernelTester()
        .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X8__AVX_X4, g_eq_2) {
    TEST_REQUIRES_X86_AVX;
    PackWMicrokernelTester()
      .g(2)
      .n(8)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16__AVX_X4, k_eq_16) {
    TEST_REQUIRES_X86_AVX;
    PackWMicrokernelTester()
      .n(16)
      .k(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16__AVX_X4, k_div_16) {
    TEST_REQUIRES_X86_AVX;
    PackWMicrokernelTester()
      .n(16)
      .k(80)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16__AVX_X4, k_lt_16) {
    TEST_REQUIRES_X86_AVX;
    for (size_t k = 1; k < 16; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16__AVX_X4, k_gt_16) {
    TEST_REQUIRES_X86_AVX;
    for (size_t k = 17; k < 32; k++) {
      PackWMicrokernelTester()
        .n(16)
  ...
  TEST(X32_PACKW_GEMM_GOI_X16__AVX_X4, g_eq_2) {
    TEST_REQUIRES_X86_AVX;
    PackWMicrokernelTester()
      .g(2)
      .n(16)
