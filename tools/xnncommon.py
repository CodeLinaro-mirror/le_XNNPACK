...
def isa_hierarchy():
    return {isa: v for v, isa in enumerate(["sse", "sse2", "ssse3", "sse41", "xop",
                                            "avx", "avx2", "avx512f", "avx512skx",
                                            "avx512vbmi", "armsimd32", "neon",
                                            "neonv8", "neondot", "neoni8mm",
                                            "wasm", "wasmsimd", "wasmrelaxedsimd","wasmsdot"])}
